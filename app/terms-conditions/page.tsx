...
export const metadata: Metadata = {
    title: 'Terms and Conditions | VIP Transfer KSA',
    description: 'Read the terms and conditions for using VIP Transfer KSA. Understand your rights and responsibilities when booking our taxi and chauffeur services.',
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Welcome to <strong>VIP Transfer KSA</strong>. These Terms and Conditions govern your use of our taxi and chauffeur services in Saudi Arabia. By booking or using our services, you agree to comply with and be bound by these terms.
                    </p>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
                    ...
                    <ul className="space-y-3 text-gray-700">
                        <li><strong>"Company," "We," "Us," "Our"</strong> refers to VIP Transfer KSA</li>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
                    ...
                    <p className="text-gray-700">
                        All content on our website, including text, graphics, logos, images, and software, is the property of VIP Transfer KSA and protected by copyright laws. You may not reproduce, distribute, or use our content without written permission.
                    </p>
                </div>
