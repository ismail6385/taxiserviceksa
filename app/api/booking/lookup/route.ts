...
const PUBLIC_FIELDS = 'id, created_at, pickup_location, destination, pickup_date, pickup_time, trip_end_date, vehicle_type, passengers, luggage, customer_name, customer_email, customer_phone, status, total_price, currency, special_requests, driver_name, driver_phone, driver_plate';
