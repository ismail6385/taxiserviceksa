...
export const metadata: Metadata = {
    title: 'Driver Jobs in Riyadh - Premium Opportunities',
    description: 'Looking for driver jobs in Riyadh? Join as a professional VIP driver. High income, own car (2020+), premium clients, and long trips.',
    keywords: ['driver jobs Riyadh', 'driver jobs in Riyadh', 'VIP drivers Riyadh'],
    alternates: {
        canonical: '/driver-jobs-riyadh',
    }
};

export default function driverjobsriyadhPage() {
    return (
        <main className="min-h-screen bg-white">
            <div className="bg-gray-950 text-white pt-32 pb-16 px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
                        Are you looking for high-paying <strong>driver jobs in Riyadh</strong>? Discover the premium opportunities available for professional drivers.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-16">
                <div className="prose prose-lg prose-gray max-w-none mb-12">
                    ...
                    <p>
                        This "own car (2020+)" standard strictly filters out the saturated, low-quality commercial markets, ensuring that our team maintains a sterling reputation across Riyadh. It places you immediately into the highest category of <strong>driver jobs</strong> available.
                    </p>
