        ...
        <main className="min-h-screen bg-white">
            ...
            <div className="bg-gray-950 text-white pt-32 pb-24 px-4 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link href="https://wa.me/966575806733" className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-2xl font-black text-lg transition-all shadow-xl shadow-emerald-900/20 flex items-center gap-3">
            ...
            <section className="py-24 px-4 bg-emerald-600">
                <div className="max-w-4xl mx-auto text-center text-white">
                    ...
                    <Link href="https://wa.me/966575806733" className="inline-flex items-center gap-3 bg-white text-emerald-600 px-12 py-5 rounded-2xl font-black text-xl hover:bg-emerald-50 transition-all shadow-2xl">
