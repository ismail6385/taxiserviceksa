            ...
            <div className="bg-[#0b1b36] text-white pt-20 pb-20 px-4 relative">
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        <a
                            href="https://wa.me/966590209905?text=Hello%2C%20I%20have%20a%20question."
                            target="_blank"
                        ...
                        <p className="text-gray-400 text-sm flex items-center gap-1 mt-2">
                            ...
                            <a href="tel:+966590209905" className="hover:text-white underline underline-offset-4 transition-colors">Or call +966 59 020 9905</a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-white rounded-[2rem] p-6 shadow-xl border border-gray-100/50">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl group cursor-pointer" onClick={() => handleCopy('+966 59 020 9905', 'phone')}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">+966 59 020 9905</p>
                                        </div>
                                    </div>
                ...
                <div className="absolute inset-0 top-32 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="w-full h-[350px] md:h-[450px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10 relative">
                        ...
                        <div className="absolute top-4 left-4 right-4 md:right-auto md:w-80 bg-white/95 backdrop-blur-md rounded-2xl p-5 shadow-2xl z-10 border border-gray-200">
                            ...
                            <a href="https://wa.me/966590209905" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full gap-2 bg-[#0b1b36] text-white py-2 rounded-xl text-sm font-bold hover:bg-[#d4af37] hover:text-[#0b1b36] transition-colors">
