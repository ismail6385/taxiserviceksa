...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al-Rass | Taxi Service KSA",
    ...
    openGraph: {
        title: "Al-Rass VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AlRassLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Al-Rass"
