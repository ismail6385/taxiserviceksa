...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Bareq | Taxi Service KSA",
    ...
    openGraph: {
        title: "Bareq VIP Transfer & Pickups | Taxi Service KSA",
...
export default function BareqLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Bareq"
