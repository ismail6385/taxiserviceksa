...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al-Jafr | Taxi Service KSA",
    ...
    openGraph: {
        title: "Al-Jafr VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AlJafrLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Al-Jafr"
