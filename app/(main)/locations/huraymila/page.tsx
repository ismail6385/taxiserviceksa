...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Huraymila | Taxi Service KSA",
    ...
    openGraph: {
        title: "Huraymila VIP Transfer & Pickups | Taxi Service KSA",
...
export default function HuraymilaLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Huraymila"
