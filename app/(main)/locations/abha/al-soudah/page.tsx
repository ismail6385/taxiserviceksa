...
export default function AlSoudahPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Abha"
                description="Professional taxi and private car services in Abha. 24/7 reliable transport for residents, business travelers, and tourists."
                services={[
                    { name: 'Abha Airport Taxi', description: 'Reliable airport pickups and drop-offs.' },
                ...
                image="https://taxiserviceksa.com/locations/abha.webp"
            />
