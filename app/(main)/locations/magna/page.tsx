...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Magna | Taxi Service KSA",
    ...
    openGraph: {
        title: "Magna VIP Transfer & Pickups | Taxi Service KSA",
...
export default function MagnaLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Magna"
