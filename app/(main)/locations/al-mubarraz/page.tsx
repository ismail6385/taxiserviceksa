...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al-Mubarraz | Taxi Service KSA",
    ...
    openGraph: {
        title: "Al-Mubarraz VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AlMubarrazLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Al-Mubarraz"
