...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Afif | Taxi Service KSA",
    ...
    openGraph: {
        title: "Afif VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AfifLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Afif"
                description="Professional VIP transfers in Afif. Specializing in airport pickups, corporate travel, and comfortable intercity transfers."
                services={[
