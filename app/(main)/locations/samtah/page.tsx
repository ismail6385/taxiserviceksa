...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Samtah | Taxi Service KSA",
    ...
    openGraph: {
        title: "Samtah VIP Transfer & Pickups | Taxi Service KSA",
...
export default function SamtahLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Samtah"
