...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car Transfer, Taxi and Chauffeur Service Jeddah to KAEC | Executive Chauffeur | Taxi Service KSA' }],
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="mailto:taxiserviceksa9988@gmail.com">
                        <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur-sm text-white border-2 border-white/30 hover:bg-white/20 font-bold text-lg px-10 py-7 rounded-2xl w-full sm:w-auto"> Business Quote
                        </Button>
                    </a>
                </div>
            </Hero>
            ...
            <div className="bg-amber-50 border-y border-amber-200 py-3 relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-center text-amber-800 text-sm font-bold flex items-center justify-center gap-2">
                        <Shield className="w-4 h-4" /> OFFICIAL NOTE: We specialize in pre-booked Intercity, Corporate, and Airport transfers. We do NOT provide local short-distance hailing.
                    </p>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed"> Our private transfer service offers the most convenient, door-to-door solution from Jeddah Airport or hotels directly to your destination in KAEC. We provide professional chauffeurs for international standards.
                            </p>
            ...
            <MicroSemanticFAQ
                ...
                faqs={[
                    ...
                    },
                    {
                        ...
                        detailedAnswer: "Yes, the Haramain High-Speed Railway connects Jeddah Airport to KAEC. However, trains run on a specific schedule. A private transfer offers flexibility if your flight time doesn't match the train schedule.",
                        perspectives: []
                    },
                    {
