...
export const metadata: Metadata = {
    title: 'Private Car Transfer, Taxi and Chauffeur Service in Buraidah | Taxi Service KSA',
    description: 'Premium private transfer and executive chauffeur service in Buraidah, Al-Qassim. Professional, reliable intercity transport and airport pickups. Book online.',
    keywords: ['Buraidah VIP private transfer', 'Executive chauffeur Buraidah', 'Buraidah taxi service', 'Buraidah airport taxi', 'Buraidah to Riyadh taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/locations/buraidah/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car Transfer, Taxi and Chauffeur Service in Buraidah | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Car Transfer, Taxi and Chauffeur Service in Buraidah | Taxi Service KSA',
        description: 'Need a premium transfer in Buraidah? We provide comfortable chauffeured trips and intercity transport.',
        url: 'https://taxiserviceksa.com/locations/buraidah/',
        type: 'website',
    },
};

export default function BuraidahLocationPage() {
    const images = [
        '/hero-slide-1.webp',
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Private Car Transfer, Taxi and Chauffeur Service in Buraidah"
                ...
                location="Buraidah, Al-Qassim | Intercity Transfers | Airport Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Buraidah&dropoff=Selected%20Hotel">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Your Buraidah Transfer
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us in Buraidah?</h3>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <ApprovedDriversForLocation location="buraidah" />

                <RelatedLocations currentCity="Buraidah" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How do I book a transfer from Buraidah?",
                        shortAnswer: "Via WhatsApp",
                        detailedAnswer: "You can book easily by sending us a message on WhatsApp. We will provide a fixed quote instantly for your Buraidah transfer.",
                        perspectives: []
                    },
                    {
                        question: "Do you go from Buraidah to Riyadh?",
                    ...
                    {
                        question: "Do you go from Buraidah to Madinah?",
                        shortAnswer: "Yes, 4 Hours",
                        detailedAnswer: "Yes, we provide direct private transfers from Buraidah to Madinah. The journey is approximately 4 hours. Fixed rates apply.",
                        perspectives: []
                    }
                ]}
            />
