...
export const metadata: Metadata = {
    title: 'VIP Private Transfer & Chauffeur Buraidah | Taxi Service KSA',
    ...
    openGraph: {
        title: 'Buraidah VIP Transfer & Pickups | Taxi Service KSA',
...
export default function BuraidahLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Buraidah"
