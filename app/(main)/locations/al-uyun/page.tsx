...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al-Uyun | Taxi Service KSA",
    ...
    openGraph: {
        title: "Al-Uyun VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AlUyunLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Al-Uyun"
                description="Professional VIP transfers in Al-Uyun. Specializing in airport pickups, corporate travel, and comfortable intercity transfers."
                services={[
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                VIP Transfer Services in Al-Uyun
                            </h2>
