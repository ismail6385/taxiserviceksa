...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Abu Arish | Taxi Service KSA",
    ...
    openGraph: {
        title: "Abu Arish VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AbuArishLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Abu Arish"
