...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Masturah | Taxi Service KSA",
    ...
    openGraph: {
        title: "Masturah VIP Transfer & Pickups | Taxi Service KSA",
...
export default function MasturahLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Masturah"
