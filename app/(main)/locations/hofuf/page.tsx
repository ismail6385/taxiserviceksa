...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Hofuf | Taxi Service KSA",
    ...
    openGraph: {
        title: "Hofuf VIP Transfer & Pickups | Taxi Service KSA",
...
export default function HofufLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Hofuf"
