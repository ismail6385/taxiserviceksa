...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Dariya | Taxi Service KSA",
    ...
    openGraph: {
        title: "Dariya VIP Transfer & Pickups | Taxi Service KSA",
...
export default function DariyaLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Dariya"
