...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al-Ghat | Taxi Service KSA",
    ...
    openGraph: {
        title: "Al-Ghat VIP Transfer & Pickups | Taxi Service KSA",
...
export default function AlGhatLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Al-Ghat"
                description="Professional VIP transfers in Al-Ghat. Specializing in airport pickups, corporate travel, and comfortable intercity transfers."
                services={[
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                VIP Transfer Services in Al-Ghat
                            </h2>
