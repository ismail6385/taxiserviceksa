...
export default function MadinahAirportPage() {
    const services = [
        ...
        { name: 'Business', description: 'Executive chauffeur service for corporate travelers.', icon: Briefcase },
    ];
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                ...
                title={
                    <span className="bg-emerald-700 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block"> Prince Mohammad Bin Abdulaziz (MED)
                    </span>
                }
                subtitle="Premium Chauffeur Service for International Pilgrims"
            ...
            <div className="bg-amber-50 border-y border-amber-200 py-3 relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-center text-amber-800 text-sm font-bold flex items-center justify-center gap-2">
                        <Shield className="w-4 h-4" /> OFFICIAL NOTE: We specialize in pre-booked Airport and Intercity transfers. We do NOT provide local short-distance hailing.
                    </p>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="prose max-w-none text-gray-700">
                            <h2 className="text-3xl font-black text-gray-900 mb-6 underline decoration-emerald-500 decoration-4 underline-offset-8">Stress-Free Madinah Airport Transfers</h2>
                            <p className="text-lg leading-relaxed mb-6">
                                Arriving at <strong>Prince Mohammad Bin Abdulaziz International Airport (MED)</strong> should be the start of a peaceful spiritual journey. Our <strong>Madinah Airport Transfer Service</strong> ensures you skip the queues and enjoy international chauffeur standards.
                            </p>
                            <p className="mb-8">
                        ...
                        <div className="bg-gray-950 rounded-3xl p-8 md:p-12 text-white relative h-full overflow-hidden">
                            ...
                            <div className="mt-10">
                                <Link href="/booking/">
                                    <Button className="w-full bg-emerald-600 text-white hover:bg-white hover:text-emerald-900 font-black h-16 rounded-xl text-lg shadow-xl shadow-emerald-900/40"> Pre-Get a quote for your Transfer
