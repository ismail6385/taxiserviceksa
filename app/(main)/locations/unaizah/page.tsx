...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Unaizah | Taxi Service KSA",
    ...
    openGraph: {
        title: "Unaizah VIP Transfer & Pickups | Taxi Service KSA",
...
export default function UnaizahLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Unaizah"
