...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Qurayyat | Taxi Service KSA",
    ...
    openGraph: {
        title: "Qurayyat VIP Transfer & Pickups | Taxi Service KSA",
...
export default function QurayyatLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Qurayyat"
