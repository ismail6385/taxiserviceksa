...
export const metadata: Metadata = {
    title: 'VIP Private Transfer & Chauffeur Al-Ahsa | Taxi Service KSA',
    ...
    openGraph: {
        title: 'Al-Ahsa VIP Transfer & Pickups | Taxi Service KSA',
...
export default function AlAhsaLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Al-Ahsa"
