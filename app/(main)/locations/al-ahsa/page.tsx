...
export const metadata: Metadata = {
    title: 'Private Car Transfer, Taxi and Chauffeur Service in Al-Ahsa | Taxi Service KSA',
    description: 'Premium private transfer and executive chauffeur service in Al-Ahsa. Professional, reliable intercity transport and airport pickups. Book online.',
    keywords: ['Al-Ahsa VIP private transfer', 'Executive chauffeur Al-Ahsa', 'Al-Ahsa taxi service', 'Hofuf taxi', 'Al-Ahsa to Dammam taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/locations/al-ahsa/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car Transfer, Taxi and Chauffeur Service in Al-Ahsa | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Car Transfer, Taxi and Chauffeur Service in Al-Ahsa | Taxi Service KSA',
        description: 'Need a premium transfer in Al-Ahsa (Hofuf)? We provide comfortable chauffeured trips and intercity transport.',
        url: 'https://taxiserviceksa.com/locations/al-ahsa/',
        type: 'website',
    },
};
...
export default function AlAhsaLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Private Car Transfer, Taxi and Chauffeur Service in Al-Ahsa"
                ...
                location="Al-Ahsa (Hofuf) | Intercity Transfers | Airport Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Al-Ahsa&dropoff=Selected%20Hotel">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Your Al-Ahsa Transfer
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us in Al-Ahsa?</h3>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <ApprovedDriversForLocation location="al-ahsa" />

                <RelatedLocations currentCity="Al-Ahsa" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How do I book a transfer from Al-Ahsa?",
                        shortAnswer: "Via WhatsApp",
                        detailedAnswer: "You can book easily by sending us a message on WhatsApp. We will provide a fixed quote instantly for your Al-Ahsa transfer.",
                        perspectives: []
                    },
                    {
                        question: "Do you go from Al-Ahsa to Dammam?",
                        shortAnswer: "Yes, 1.5 Hours",
                        detailedAnswer: "Yes, we provide frequent private transfers between Al-Ahsa (Hofuf) and Dammam. The journey takes approximately 1.5 hours on the highway.",
                        perspectives: []
                    },
                    {
                        question: "Can I book a ride from Al-Ahsa to Riyadh?",
                        shortAnswer: "Yes, 4 Hours",
                        detailedAnswer: "Absolutely. We offer direct private transfers from Al-Ahsa to Riyadh. The journey is approximately 4 hours. Fixed rates apply.",
                        perspectives: []
                    }
                ]}
            />
