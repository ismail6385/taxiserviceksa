...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur KAEC | Taxi Service KSA",
    ...
    openGraph: {
        title: "KAEC VIP Transfer & Pickups | Taxi Service KSA",
...
export default function KAECLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="KAEC"
                description="Professional VIP transfers in KAEC. Specializing in airport pickups, corporate travel, and comfortable intercity transfers."
                services={[
