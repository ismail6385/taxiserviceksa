...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Taxi Service in Jarwal Makkah | King Abdullah Expansion Access | Taxi Service KSA',
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <section className="py-24 bg-blue-600 text-center relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10">
                    <h2 className="text-4xl md:text-5xl font-black text-white mb-8">Staying in Jarwal? WhatsApp Booking to the Haram Today.</h2>
