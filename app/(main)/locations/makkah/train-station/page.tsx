...
export const metadata: Metadata = {
    title: 'Private Car Transfer, Taxi and Chauffeur Service in Makkah Train Station | Premium Chauffeur | Taxi Service KSA',
    description: 'Premium private transfer and executive chauffeur service from Makkah Haramain Train Station (Rusaifah). Professional pickup for Umrah pilgrims.',
...
export default function MakkahTrainStationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Private Car Transfer, Taxi and Chauffeur Service in Makkah Train Station"
                ...
                subtitle="Exclusive Arrival Service for Haramain Railway Guests"
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Makkah%20Train%20Station&dropoff=Clock%20Tower">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Your Makkah Train Station Transfer
