...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Rabigh | Taxi Service KSA",
    ...
    openGraph: {
        title: "Rabigh VIP Transfer & Pickups | Taxi Service KSA",
...
export default function RabighLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Rabigh"
