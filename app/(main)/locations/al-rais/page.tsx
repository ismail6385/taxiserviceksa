...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Al Rais | Taxi Service KSA",
    description: "Premium VIP private transfer and executive chauffeur service in Al Rais. Professional, reliable intercity transport and airport pickups.",
    keywords: ["Al Rais VIP private transfer", "Executive chauffeur Al Rais", "Al Rais Airport VIP pickup", "Premium driver Al Rais"],
    alternates: {
        canonical: "https://taxiserviceksa.com/locations/al-rais/",
    },
    openGraph: {
        title: "Al Rais VIP Transfer & Pickups | Taxi Service KSA",
        description: "Need a premium VIP transfer in Al Rais? We provide comfortable chauffeured trips and intercity transport.",
        url: "https://taxiserviceksa.com/locations/al-rais/",
        type: "website",
    },
};

export default function AlRaisLocationPage() {
    const images = [
        '/hero-slide-4.webp',
        '/hero-slide-2.webp',
        '/hero-slide-2.webp',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Al Rais"
                description="Professional VIP transfers in Al Rais. Specializing in airport pickups, corporate travel, and comfortable intercity transfers."
                services={[
                    { name: "Al Rais Airport Pickup", description: "VIP meet & greet at the airport with flight tracking." },
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Al Rais"
                bookingFormTitle="WhatsApp Booking for Premium Transfer in Al Rais"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        VIP Chauffeur Service Al Rais
                    </span>
                }
                subtitle="Premium Executive Transport Excellence"
                location="Al Rais | Intercity Transfers | Airport Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Al Rais&dropoff=Selected%20Hotel">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                VIP Transfer Services in Al Rais
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Navigating Al Rais requires a reliable and comfortable mode of transport. Whether you are traveling for business, visiting family, or heading out for a long-distance intercity journey, our premium fleet is ready to serve you.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us in Al Rais?</h3>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <RelatedLocations currentCity="Al Rais" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How do I book a transfer from Al Rais?",
