...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Umluj | Taxi Service KSA",
    ...
    openGraph: {
        title: "Umluj VIP Transfer & Pickups | Taxi Service KSA",
...
export default function UmlujLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Umluj"
