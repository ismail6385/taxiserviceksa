...
export const metadata: Metadata = {
    title: 'Private Car Transfer, Taxi and Chauffeur Service in Khamis Mushait | Taxi Service KSA',
    description: 'Premium private transfer and executive chauffeur service in Khamis Mushait. Professional, reliable intercity transport and airport pickups. Book online.',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car Transfer, Taxi and Chauffeur Service in Khamis Mushait | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Car Transfer, Taxi and Chauffeur Service in Khamis Mushait | Taxi Service KSA',
        description: 'Need a premium transfer in Khamis Mushait? We provide comfortable chauffeured trips and intercity transport.',
...
export default function KhamisMushaitLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Private Car Transfer, Taxi and Chauffeur Service in Khamis Mushait"
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Khamis%20Mushait&dropoff=Selected%20Hotel">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Your Khamis Mushait Transfer
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <ApprovedDriversForLocation location="khamis-mushait" />
