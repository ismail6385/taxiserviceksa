...
export const metadata: Metadata = {
    title: "VIP Private Transfer & Chauffeur Thuwal | Taxi Service KSA",
    ...
    openGraph: {
        title: "Thuwal VIP Transfer & Pickups | Taxi Service KSA",
...
export default function ThuwalLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Thuwal"
