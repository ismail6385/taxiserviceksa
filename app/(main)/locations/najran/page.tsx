...
export const metadata: Metadata = {
    title: 'VIP Private Transfer & Chauffeur Najran | Taxi Service KSA',
    ...
    openGraph: {
        title: 'Najran VIP Transfer & Pickups | Taxi Service KSA',
...
export default function NajranLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="VIP Private Transfer & Chauffeur Najran"
