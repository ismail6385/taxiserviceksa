...
export const metadata: Metadata = {
    ...
    description: 'Premium private transfer and executive chauffeur service in Al-Qassim region. Professional, reliable intercity transport and airport pickups. Book online.',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car Transfer, Taxi and Chauffeur Service in Al-Qassim | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Car Transfer, Taxi and Chauffeur Service in Al-Qassim | Taxi Service KSA',
        description: 'Need a premium transfer in Al-Qassim? We provide comfortable chauffeured trips and intercity transport.',
...
export default function AlQassimLocationPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                cityName="Al-Qassim"
                description="Professional transfers in Al-Qassim region. Specializing in airport pickups, corporate travel, and comfortable intercity transfers across Saudi Arabia."
                services={[
                    { name: 'Al-Qassim Airport Pickup', description: 'Meet & greet at Prince Nayef bin Abdulaziz Airport with flight tracking.' },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Transfer Services in Al-Qassim
                            </h2>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                We prioritize safety, punctuality, and discretion. Pre-book a dedicated chauffeur from Al-Qassim to Riyadh, Madinah, or anywhere across Saudi Arabia.
                            </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <ApprovedDriversForLocation location="al-qassim" />
