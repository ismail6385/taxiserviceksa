                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="bg-white rounded-2xl p-8 border-2 border-gray-100 shadow-sm">
                        ...
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <li><Link href="/places-to-visit-in-saudi-arabia/" className="text-gray-600 hover:text-primary flex items-center gap-2 group"><ArrowRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 transition-all" /> Top Places to Visit in Saudi Arabia</Link></li>
                            <li><Link href="/insights/pilgrimage-transport-report-2026/" className="text-emerald-600 font-bold hover:text-primary flex items-center gap-2 group"><ArrowRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 transition-all" /> 2026 Transport Report</Link></li>
                        </ul>
                    </div>
                </div>
