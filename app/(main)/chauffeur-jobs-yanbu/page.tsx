...
export const metadata: Metadata = {
    title: 'Chauffeur Jobs in Yanbu - Premium Opportunities',
    description: 'Looking for chauffeur jobs in Yanbu? Join as a professional VIP driver. High income, own car (2020+), premium clients, and long trips.',
    keywords: ['chauffeur jobs Yanbu', 'chauffeur jobs in Yanbu', 'VIP drivers Yanbu'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/chauffeur-jobs-yanbu',
    }
};

export default function ChauffeurJobsYanbuPage() {
    return (
        <main className="min-h-screen bg-white">
            <JsonLdBreadcrumb 
                items={[
                    { name: 'Home', item: '/' },
                    { name: 'Yanbu Jobs', item: '/chauffeur-jobs-yanbu' }
                ]}
            />
            <JsonLdJobPosting 
                title="VIP Chauffeur - Yanbu"
                description="Join our elite network of professional chauffeurs in Yanbu. We are looking for drivers with their own 2020+ model cars to serve VIP clients, industrial executives, and international travelers. High income potential with specialized port-to-city and long-distance routes."
            ...
            <div className="bg-gray-950 text-white pt-32 pb-16 px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black mb-6 leading-tight">
                        Chauffeur Jobs in Yanbu
                    </h1>
                    <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
                        Are you looking for high-paying <strong>chauffeur jobs in Yanbu</strong>? Discover the premium opportunities available for professional drivers.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-16">
                <div className="prose prose-lg prose-gray max-w-none mb-12">
                    ...
                    <p>
                        This "own car (2020+)" standard strictly filters out the saturated, low-quality commercial markets, ensuring that our team maintains a sterling reputation across Yanbu. It places you immediately into the highest category of <strong>chauffeur jobs</strong> available.
                    </p>
                    ...
                    <div className="bg-gray-50 border border-gray-200 p-8 rounded-2xl mt-12 text-center">
                        ...
                        <Link href="/join-as-driver/yanbu" className="inline-flex items-center justify-center bg-primary hover:bg-black text-white font-black py-4 px-8 rounded-xl transition-all">
                            Apply as a driver in Yanbu &rarr;
                        </Link>
                    </div>
                </div>
            </div>
