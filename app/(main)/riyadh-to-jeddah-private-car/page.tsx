...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Yes. One-way transfers are available from Riyadh to Jeddah (and Jeddah to Riyadh). We also offer return trips and multi-city bookings. Book via WhatsApp at +966 56 948 7569 with your preferred departure date, time, and pick-up address in Riyadh.',
    },
    {
            ...
            <section className="bg-gradient-to-br from-gray-950 via-gray-900 to-emerald-950 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a
                            href="https://wa.me/966569487569?text=Hi,%20I%20need%20a%20private%20car%20from%20Riyadh%20to%20Jeddah"
                            target="_blank"
                        ...
                        {vehicles.map((v, i) => (
                            <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:border-emerald-300 transition-all flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
                                ...
                                <div className="text-right">
                                    ...
                                    <a
                                        href={`https://wa.me/966569487569?text=Hi,%20I%20need%20${v.name}%20from%20Riyadh%20to%20Jeddah`}
                                        target="_blank"
                                        rel="noopener noreferrer"
