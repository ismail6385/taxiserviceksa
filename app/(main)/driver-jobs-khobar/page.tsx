...
export const metadata: Metadata = {
    title: 'Driver Jobs in Khobar - Premium Opportunities',
    description: 'Looking for driver jobs in Khobar? Join as a professional VIP driver. High income, own car (2020+), premium clients, and long trips.',
    keywords: ['driver jobs Khobar', 'driver jobs in Khobar', 'VIP drivers Khobar'],
    alternates: {
        canonical: '/driver-jobs-khobar',
    }
};

export default function driverjobskhobarPage() {
    return (
        <main className="min-h-screen bg-white">
            <div className="bg-gray-950 text-white pt-32 pb-16 px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black mb-6 leading-tight">
                        Driver Jobs in Khobar
                    </h1>
                    <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
                        Are you looking for high-paying <strong>driver jobs in Khobar</strong>? Discover the premium opportunities available for professional drivers.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-16">
                <div className="prose prose-lg prose-gray max-w-none mb-12">
                    ...
                    <p>
                        This "own car (2020+)" standard strictly filters out the saturated, low-quality commercial markets, ensuring that our team maintains a sterling reputation across Khobar. It places you immediately into the highest category of <strong>driver jobs</strong> available.
                    </p>
                    ...
                    <div className="bg-gray-50 border border-gray-200 p-8 rounded-2xl mt-12 text-center">
                        ...
                        <Link href="/join-as-driver/khobar" className="inline-flex items-center justify-center bg-primary hover:bg-black text-white font-black py-4 px-8 rounded-xl transition-all">
                            Apply as a driver in Khobar &rarr;
                        </Link>
                    </div>
                </div>
            </div>
