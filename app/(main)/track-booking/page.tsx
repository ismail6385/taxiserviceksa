            ...
            <div className="max-w-xl mx-auto">
                ...
                {booking && statusCfg && (
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            {/* WhatsApp CTA */}
                            <a
                                href={`https://wa.me/966590209905?text=${encodeURIComponent(`Hello, I'd like to ask about my booking.\n\nRef: #${booking.id.slice(0,8).toUpperCase()}\nName: ${booking.customer_name}`)}`}
                ...
                {!booking && !notFound && (
                    <div className="text-center text-sm text-gray-400 mt-6">
                        <p>Can't find your booking? <a href="https://wa.me/966590209905" className="text-black font-bold underline">Contact us on WhatsApp</a></p>
                    </div>
                )}
            </div>
        </main>
