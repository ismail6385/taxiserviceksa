...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service for GCC Cross-Border Travel | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Private chauffeur service from Saudi Arabia to the UAE, Kuwait, Qatar, and Bahrain. Cross-border door-to-door transfers with fixed rates and professional drivers."
                services={[
            ...
            <Hero
                ...
                location="100% Private — No Shared Rides"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/966590209905?text=Hello%2C%20I%20need%20a%20cross-border%20GCC%20chauffeur%20quote." target="_blank" rel="noopener noreferrer">
