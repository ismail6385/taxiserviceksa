        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966569487569?text=Hello,%20I%20need%20a%20hotel%20transfer%20in%20Riyadh" target="_blank">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-center mt-8 text-sm text-gray-500">Don't see your hotel? We cover <strong>all hotels</strong> in Riyadh. <Link href="https://wa.me/966569487569?text=Hello,%20I%20need%20a%20hotel%20transfer%20in%20Riyadh" className="text-black font-bold hover:underline">Contact us →</Link></p>
                </div>
            </section>
