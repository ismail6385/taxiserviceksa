...
const faqs = [
    {
        ...
        answer: 'You can pre-book a private car via WhatsApp at +966 57 580 6733 or through our online form. Provide your cruise arrival time and ship name. Your chauffeur will be waiting outside the cruise terminal gate with a name sign.',
    },
    {
            ...
            <section className="bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="https://wa.me/966575806733?text=Hi,%20I%20need%20a%20taxi%20from%20Jeddah%20Islamic%20Port" target="_blank" rel="noopener noreferrer"
