...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Sabya Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
...
export default function TabukSabyaRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '1600 km', icon: Navigation },
        { label: 'Travel Time', value: '15-17 Hours', icon: Clock },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Sabya"
                description="Professional private car service from Tabuk to Sabya. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Sabya Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Sabya.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Sabya back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="15-17 Hours | WhatsApp Booking | Local Drivers"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-sabya">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Sabya</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>The route from Tabuk to Sabya runs roughly 1600 km, ending in a town in the Jazan region, part of the fertile coastal plain in the far south of the Kingdom. We keep the trip simple: one private vehicle, one driver, and a fixed price agreed before you leave.</p>
                            <p>This route is popular with travelers going for a family visit to the Jazan area. Figure on roughly 15-17 Hours in the car, with the driver stopping for meals or prayer whenever you ask, not on a fixed schedule.</p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Sabya.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Sabya.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                ...
                faqs={[
                {
                        question: "Is Sabya close to Jizan city?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Sabya sits within the wider Jazan region, not far from Jizan city itself.",
                        perspectives: []
                    },
                                    {
                        question: "Given the distance, do you recommend an overnight stop?",
                        shortAnswer: "Verified",
                        detailedAnswer: "This is one of the longer routes from Tabuk, so some travelers choose to split it into two days — mention it when booking if you would like to discuss that option.",
                        perspectives: []
                    },
                                    {
                        question: "Do I pay extra for luggage on this trip?",
                        shortAnswer: "Verified",
                        detailedAnswer: "No. As long as your bags fit in the vehicle you booked, there is no extra charge for luggage on the way to Sabya.",
                        perspectives: []
                    },
                                    {
                        question: "Can I book a pickup in Tabuk at night or very early morning?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. We run this route 24/7, so an early morning or late night departure from Tabuk for Sabya can be arranged.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Sabya.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Sabya?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-sabya" />
            </div>
        </div>
    );
}
