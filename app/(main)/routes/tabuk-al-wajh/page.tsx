...
export const metadata: Metadata = {
    title: 'Tabuk to Al Wajh Taxi | Private Car Service 330 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Al Wajh. Reliable 3.5 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Al Wajh taxi', 'taxi from Tabuk to Al Wajh', 'private transfer Tabuk to Al Wajh', 'chauffeur Tabuk to Al Wajh', 'Tabuk to Al Wajh car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-al-wajh/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Al Wajh Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Al Wajh Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 330 km drive. Request a quote for a comfortable ride from Tabuk to Al Wajh. Professional service available 24/7.',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service from Tabuk to Al Wajh. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Al Wajh Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Al Wajh.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Al Wajh back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="3.5 Hours | WhatsApp Booking | Local Drivers"
            >
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Al Wajh</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Traveling from Tabuk to Al Wajh covers around 330 km, taking you through to a historic Red Sea port town that served as a key stop on the old Hejaz Railway and during the 1916 Arab Revolt, with coral reefs just offshore. Instead of dealing with shared transport or fixed bus schedules, our private car service handles the whole distance door-to-door.</p>
                            <p>Most people booking this route are traveling for a coastal trip or a visit tied to the area's history. The drive takes about 3.5 Hours, and since it's a private vehicle, the pace and stops are set around you, not a fixed timetable.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">The main advantage of booking privately is control: you set the departure time, you decide where to stop on the way to Al Wajh, and you're not sharing the vehicle with strangers. We agree the fare upfront, and our drivers are familiar with this route and its rest stops.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Al Wajh.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Al Wajh.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk Al Wajh"
                faqs={[
                {
                        question: "Is Al-Wajh known for anything besides the port?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Al-Wajh has a notable history tied to the old Hejaz Railway and the Arab Revolt era, and its offshore reefs are known among Red Sea divers.",
                        perspectives: []
                    },
                                    {
                        question: "Is the coast road from Tabuk to Al-Wajh scenic?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, the route runs close to the Red Sea coastline for a good stretch, which makes for a pleasant drive.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Al Wajh take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 3.5 Hours, covering close to 330 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                                    {
                        question: "Is the price for the whole vehicle, not per seat?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Al Wajh — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                                    {
                        question: "Do I pay extra for luggage on this trip?",
                        shortAnswer: "Verified",
                        detailedAnswer: "No. As long as your bags fit in the vehicle you booked, there is no extra charge for luggage on the way to Al Wajh.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Al Wajh?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-al-wajh" />
            </div>
        </div>
    );
}
