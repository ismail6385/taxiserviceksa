...
export const metadata: Metadata = {
    title: 'Dammam Airport to Hawally Taxi | Nuwaiseeb Border Transfer | Taxi Service KSA',
    description: 'Book a private taxi from King Fahd International Airport (Dammam) to Hawally, Kuwait via the Nuwaiseeb border. Fixed rates, door-to-door, 24/7.',
    keywords: ['Dammam Airport to Hawally taxi', 'DMM to Hawally taxi', 'Nuwaiseeb border Hawally', 'Dammam Airport Hawally transfer', 'Saudi Hawally taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dammam-airport-to-hawally-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to Hawally Taxi | Fixed Price Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dammam Airport to Hawally Taxi | Fixed Price Transfer | Taxi Service KSA',
        description: 'Direct private transfer from King Fahd International Airport (DMM) to Hawally, Kuwait via the Nuwaiseeb border crossing.',
        url: 'https://taxiserviceksa.com/routes/dammam-airport-to-hawally-taxi/',
        type: 'website',
    },
};

export default function DammamAirportToHawallyTaxiPage() {
    const routeDetails = [
        { label: 'Distance', value: '~435 km', icon: MapPin },
        ...
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                services={[
                    ...
                    { name: 'Hotel & Residence Transfers', description: 'Direct drop-off at Hawally apartments, hotels, or offices.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Dammam Airport to Hawally Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Nuwaiseeb Border Route
                    </span>
                }
                subtitle="Direct Transfer to Kuwait&apos;s Densest District"
                location="Door-to-Door | Residential & Commercial | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Hawally">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Hawally Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Hawally: Dense & Central
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Hawally</strong> is one of Kuwait&apos;s most densely populated governorates, sitting just southeast of Kuwait City. It&apos;s known for its busy shopping streets, budget-friendly apartments, and large South Asian and Arab expat community.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the Nuwaiseeb border crossing, and drops you at your Hawally apartment, hotel, or office.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Building2 className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Dense Urban Area</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off in Hawally</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off at your Hawally apartment, hotel, or office building.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Hawally"
                faqs={[
                    {
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to Hawally take?',
                        shortAnswer: '4.5-5.5 Hours',
                        detailedAnswer: 'The journey covers approximately 435 kilometers via the Nuwaiseeb land border. Total time is usually 4.5 to 5.5 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you drop us at a specific building in Hawally?',
                        shortAnswer: 'Yes, door-to-door',
                        detailedAnswer: 'Yes, our service is door-to-door. Tell us your exact street, building, or landmark in Hawally and we will drop you there directly.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Hawally Taxi
                    </h2>
                    <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                        A direct, private transfer from arrivals to Hawally — no rental car, no hassle.
                    </p>
