...
export const metadata: Metadata = {
    title: 'Abu Dhabi to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Abu Dhabi to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA' }],
...
export default function AbuDhabiMakkahRoutePage() {
    const images = [
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
        '/jeddah-airport.webp'
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Abu Dhabi to Makkah"
                description="Professional private car service for Abu Dhabi to Makkah. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
                    { name: 'Abu Dhabi to Makkah Taxi', description: 'Premium private transfer with guaranteed fixed rates.' },
            ...
            <Hero
                images={images}
                h1Text="Abu Dhabi to Makkah Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Abu Dhabi to Makkah"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Abu Dhabi&dropoff=Makkah">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            WhatsApp Booking
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Abu Dhabi%20to%20Makkah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Abu Dhabi to Makkah covers approximately 2,000 km, at around 19.5 hours of driving. We plan this honestly as a two-day journey with a scheduled overnight stop, so pilgrims arrive ready for Umrah rather than exhausted.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~2,000 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Rather than a 19.5-hour non-stop push, we build in a proper overnight rest roughly midway.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                <TravelConsensus
                        contextName="Abu Dhabi Makkah"
                        points={[
                            {
                                topic: "Meeqat Timing",
                                commonBelief: "You can enter Ihram any time before Makkah.",
                                reality: "Pilgrims must enter Ihram at or before the Meeqat boundary for their route — our drivers know exactly where this is on the Abu Dhabi-Makkah road and will stop there on request.",
                            ...
                            },
                            {
                                ...
                                reality: "At 2,000 km and around 19.5 hours, we don't book this as a single push — a scheduled overnight stop means pilgrims arrive rested and ready for Umrah, not exhausted from a marathon drive.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="abu-dhabi" currentSlug="abu-dhabi-makkah" />
            </div>
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: "Pilgrims travelling from Abu Dhabi typically enter Ihram at Qarn al-Manazil or Dhul Hulaifah depending on the exact route taken — tell your driver you need a Meeqat stop when booking and they'll plan accordingly.",
                        perspectives: []
                    },
                    {
                        question: "Is this a one-day or two-day journey?",
                        shortAnswer: "Two days, with an overnight stop",
                        detailedAnswer: "At around 19.5 hours and 2,000 km, we plan this as a two-day journey with a scheduled overnight stop so you arrive rested and ready for Umrah, not exhausted from a non-stop drive.",
                        perspectives: []
                    },
                    {
