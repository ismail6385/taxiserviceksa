...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Samtah Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
...
export default function TabukSamtahRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '1680 km', icon: Navigation },
        { label: 'Travel Time', value: '16-18 Hours', icon: Clock },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Samtah"
                description="Professional private car service from Tabuk to Samtah. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Samtah Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Samtah.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Samtah back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="16-18 Hours | WhatsApp Booking | Local Drivers"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-samtah">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Samtah</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Traveling from Tabuk to Samtah covers around 1680 km, taking you through to a Jazan-region town near the Yemeni border, in the far south of the Kingdom. Instead of dealing with shared transport or fixed bus schedules, our private car service handles the whole distance door-to-door.</p>
                            <p>Most people booking this route are traveling for a family visit near the southern border. The drive takes about 16-18 Hours, and since it's a private vehicle, the pace and stops are set around you, not a fixed timetable.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">The main advantage of booking privately is control: you set the departure time, you decide where to stop on the way to Samtah, and you're not sharing the vehicle with strangers. We agree the fare upfront, and our drivers are familiar with this route and its rest stops.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Samtah.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Samtah.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                ...
                faqs={[
                {
                        question: "Is Samtah close to the Yemen border?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, Samtah sits in the southern part of the Jazan region near the Yemeni border.",
                        perspectives: []
                    },
                                    {
                        question: "Is this one of your longer routes?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, this is one of the longer trips we offer from Tabuk given how far south Samtah sits.",
                        perspectives: []
                    },
                                    {
                        question: "Is the price for the whole vehicle, not per seat?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Samtah — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                                    {
                        question: "Do I pay extra for luggage on this trip?",
                        shortAnswer: "Verified",
                        detailedAnswer: "No. As long as your bags fit in the vehicle you booked, there is no extra charge for luggage on the way to Samtah.",
                        perspectives: []
                    },
                                    {
                        question: "Can I book a pickup in Tabuk at night or very early morning?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. We run this route 24/7, so an early morning or late night departure from Tabuk for Samtah can be arranged.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Samtah?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-samtah" />
            </div>
        </div>
    );
}
