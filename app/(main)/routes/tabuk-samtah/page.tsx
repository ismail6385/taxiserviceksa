                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Booking a private car from Tabuk to Samtah is the most convenient way to handle the 1680 km journey. Avoid the hassle of shared taxis or fixed bus routes. We provide a door-to-door service that caters to your specific needs. Whether you are traveling for a family visit or a business commitment in Samtah, our chauffeurs ensure a smooth ride on the open road.</p>
                            <p>Traveling for 16-18 Hours can be tiring if you aren't in the right car. That is why we use only high-quality sedans and SUVs for our Samtah routes. You will find that our door-to-door service is the most relaxing way to manage this long-distance move.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                        ...
                        detailedAnswer: "It usually takes about 16-18 Hours. The distance is close to 1680 km. We use the main highways and keep a steady pace to get you there on time.",
                        perspectives: []
                    },
                    {
                        question: "Is the price for the whole car?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to Samtah.",
                        perspectives: []
                    },
                    {
                        question: "How do I Request a quote for a pickup in Tabuk?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. Just provide your location in Tabuk, and our driver will meet you there to take you directly to Samtah.",
                        perspectives: []
                    },
                    {
                        question: "Where do we stop for food on the way to Samtah?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We stop at good service stations like SASCO. During the 1680 km trip, you can ask the driver to stop whenever you need a break for a meal or prayer.",
                        perspectives: []
                    },
                    {
