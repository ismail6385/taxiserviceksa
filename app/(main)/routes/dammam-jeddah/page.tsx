...
export const metadata: Metadata = {
    title: 'Dammam to Jeddah Taxi | Cross-Country Private Transfers | Taxi Service KSA',
    description: 'Book a private taxi from Dammam to Jeddah. Door-to-door long-distance transfers across Saudi Arabia in a comfortable GMC or Staria. Fixed rates, professional drivers.',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Taxi: Dammam to Jeddah | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Taxi: Dammam to Jeddah | Taxi Service KSA',
        description: 'Cross-country transfer from Dammam to Jeddah in a private, air-conditioned vehicle. Overnight and multi-stop options available.',
        url: 'https://taxiserviceksa.com/routes/dammam-jeddah/',
        type: 'website',
    },
};

export default function DammamJeddahRoutePage() {
    const images = [
        '/hero-slide-2.webp',
        '/hero-slide-1.webp',
        '/hero-slide-3.webp',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Dammam to Jeddah Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Coast to Coast, Private & Direct
                    </span>
                }
                subtitle="Eastern Province to the Red Sea | 13-14 Hours | 100% Private"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam to Jeddah: The Full Saudi Crossing
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Dammam to Jeddah is one of the longest domestic routes in the Kingdom, crossing the peninsula from the Arabian Gulf to the Red Sea coast. Most travellers fly this route, but for families, groups with heavy luggage, or anyone who prefers a private overland journey, a chauffeured car is a comfortable alternative.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Pick up anywhere in Dammam, Khobar, or Dhahran, drop off anywhere in Jeddah including the airport or Corniche.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <div className="bg-black py-24 text-center px-4 relative overflow-hidden rounded-3xl mx-4 mb-12">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <h2 className="text-3xl md:text-5xl font-black text-white mb-8 leading-tight">Get a quote for your Dammam to Jeddah Taxi</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="dammam" currentSlug="dammam-jeddah" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long is the drive from Dammam to Jeddah?",
                    ...
                    {
                        question: "Do you drop off at Jeddah Airport?",
                        shortAnswer: "Yes",
                        detailedAnswer: "Yes, we can drop you off at King Abdulaziz International Airport (JED) in Jeddah, or any hotel, office, or residence in the city.",
                        perspectives: []
                    }
                ]}
            />
