...
export const metadata: Metadata = {
    title: 'Tabuk to Riyadh Taxi | Private Car Service 1280 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Riyadh. Reliable 12-13 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Riyadh taxi', 'taxi from Tabuk to Riyadh', 'private transfer Tabuk to Riyadh', 'chauffeur Tabuk to Riyadh', 'Tabuk to Riyadh car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-riyadh/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Riyadh Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Riyadh Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1280 km drive. Request a quote for a comfortable ride from Tabuk to Riyadh. Professional service available 24/7.',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service from Tabuk to Riyadh. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Riyadh Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Riyadh.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Riyadh back to Tabuk at competitive rates.' }
                ]}
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-riyadh">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Riyadh</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Traveling from Tabuk to Riyadh covers around 1280 km, taking you through to the national capital and largest city in the Kingdom, a major business, government, and family destination. Instead of dealing with shared transport or fixed bus schedules, our private car service handles the whole distance door-to-door.</p>
                            <p>Most people booking this route are traveling for business travel or a family visit to the capital. The drive takes about 12-13 Hours, and since it's a private vehicle, the pace and stops are set around you, not a fixed timetable.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">The main advantage of booking privately is control: you set the departure time, you decide where to stop on the way to Riyadh, and you're not sharing the vehicle with strangers. We agree the fare upfront, and our drivers are familiar with this route and its rest stops.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Riyadh.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Riyadh.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Riyadh"
                faqs={[
                {
                        question: "Can you drop us at a specific business district or address in Riyadh?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, we take you directly to your hotel, office, or any address in Riyadh, including business districts like Olaya or KAFD.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the Tabuk to Riyadh drive usually take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "The travel time is shown in the trip details above — it is one of our longer routes, so the driver plans proper rest stops along the way.",
                        perspectives: []
                    },
                                    {
                        question: "Can I book a pickup in Tabuk at night or very early morning?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. We run this route 24/7, so an early morning or late night departure from Tabuk for Riyadh can be arranged.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Riyadh.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Riyadh take?",
                        shortAnswer: "Verified",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-riyadh" />
            </div>
        </div>
    );
}
