                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>If you need a ride from Tabuk to Riyadh, we have you covered. Our local drivers know the roads well and handle the long stretch of highway for you. We provide clean, modern vehicles for the 1280 km trip. You don't have to worry about schedules or luggage limits. Just Get a quote for your time, and we will show up at your house or hotel in Tabuk to start the drive to Riyadh.</p>
                            <p>From the northern borders down towards Riyadh, our service bridges the gap for those who prefer private travel. We avoid the busy terminals and give you a direct route that saves you hours of waiting and multiple transfers.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                        ...
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to Riyadh.",
                        perspectives: []
                    },
                    {
                        question: "Where do we stop for food on the way to Riyadh?",
                        shortAnswer: "Verified",
                    ...
                    },
                    {
                        ...
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. Just provide your location in Tabuk, and our driver will meet you there to take you directly to Riyadh.",
                        perspectives: []
                    },
                ]}
            />
