...
export const metadata: Metadata = {
    title: 'Taxi Madinah to Bahrain | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Madinah to Bahrain. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function MadinahBahrainRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Madinah to Bahrain."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-madinah-bahrain"
            ...
            <RouteBreadcrumb fromCity="Madinah" toCity="Bahrain" fromSlug="madinah" toSlug="bahrain" />

            <Hero
                images={images}
                h1Text="Taxi Madinah to Bahrain"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Madinah%20to%20Bahrain">
