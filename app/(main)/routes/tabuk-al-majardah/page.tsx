...
export const metadata: Metadata = {
    title: 'Tabuk to Al Majardah Taxi | Private Car Service 1420 km | Fixed Price',
    ...
    openGraph: {
        title: 'Tabuk to Al Majardah Taxi | Private Transfer - Fixed Price',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                ...
                location="14 Hours | Fixed Rates | Local Drivers"
            >
