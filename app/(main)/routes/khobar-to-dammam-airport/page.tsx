                ...
                <div className="max-w-7xl mx-auto">
                    <div className="bg-blue-50 rounded-3xl p-8 md:p-12 border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex-1">
                            ...
                            <a href="https://wa.me/966569487569?text=Hello,%20I%20want%20to%20book%20a%20taxi%20from%20Khobar%20to%20Dammam%20Airport" className="w-full bg-blue-600 text-white hover:bg-blue-700 font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-xl">
