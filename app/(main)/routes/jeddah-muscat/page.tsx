...
export const metadata: Metadata = {
    title: 'Jeddah to Muscat Taxi | VIP Cross-Border Transfer | Taxi Service KSA',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional VIP private car service for Jeddah to Muscat. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
            ...
            <Hero
                ...
                subtitle="Seamless VIP Transfers: Jeddah to Muscat"
