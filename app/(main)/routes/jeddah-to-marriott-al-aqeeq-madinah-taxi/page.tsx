...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Jeddah Airport to Marriott Al Aqeeq Taxi | Fixed Price Transfer | Taxi Service KSA' }],
