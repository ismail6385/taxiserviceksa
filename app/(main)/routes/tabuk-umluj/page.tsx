                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Booking a private car from Tabuk to Umluj is the most convenient way to handle the 480 km journey. Avoid the hassle of shared taxis or fixed bus routes. We provide a door-to-door service that caters to your specific needs. Whether you are traveling for a family visit or a business commitment in Umluj, our chauffeurs ensure a smooth ride on the open road.</p>
                            <p>Traveling for 4.5-5 Hours can be tiring if you aren't in the right car. That is why we use only high-quality sedans and SUVs for our Umluj routes. You will find that our door-to-door service is the most relaxing way to manage this long-distance move.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                        ...
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to Umluj.",
                        perspectives: []
                    },
                    {
                    ...
                    },
                    {
                        ...
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. Just provide your location in Tabuk, and our driver will meet you there to take you directly to Umluj.",
                        perspectives: []
                    },
                    {
                    ...
                    {
                        question: "Where do we stop for food on the way to Umluj?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We stop at good service stations like SASCO. During the 480 km trip, you can ask the driver to stop whenever you need a break for a meal or prayer.",
                        perspectives: []
                    },
                ]}
            />
