...
export const metadata: Metadata = {
    title: 'Taxi Makkah to Sharjah | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Makkah to Sharjah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function MakkahSharjahRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Makkah to Sharjah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-makkah-sharjah"
            ...
            <RouteBreadcrumb fromCity="Makkah" toCity="Sharjah" fromSlug="makkah" toSlug="sharjah" />

            <Hero
                images={images}
                h1Text="Taxi Makkah to Sharjah"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Makkah%20to%20Sharjah">
