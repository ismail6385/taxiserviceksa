...
const WA_LINK = "https://wa.me/966590209905?text=Hello%2C%20I%20want%20to%20book%20a%20VIP%20taxi%20from%20Riyadh%20to%20Dubai.%20Please%20share%20availability.";
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="riyadh" currentSlug="riyadh-dubai" />
            </div>
        </div>
    );
}
