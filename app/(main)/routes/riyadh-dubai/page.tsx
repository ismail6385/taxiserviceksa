...
export const metadata: Metadata = {
    title: 'Taxi Riyadh to Dubai | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Riyadh to Dubai. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
    keywords: ['Taxi Riyadh to Dubai', 'Riyadh to Dubai transfer', 'cross border taxi Saudi Arabia', 'VIP transport Riyadh Dubai'],
    alternates: {
...
export default function RiyadhDubaiRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Riyadh to Dubai."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Riyadh" toCity="Dubai" fromSlug="riyadh" toSlug="dubai" />

            <Hero
                images={images}
                h1Text="Taxi Riyadh to Dubai"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless VIP Transfers: Riyadh to Dubai"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Riyadh&dropoff=Dubai">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Get Quote
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Riyadh%20to%20Dubai">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Riyadh to Dubai
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Riyadh and Dubai by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 1000 km, and the journey typically takes 10-12 hours.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">10-12 hours Journey</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Riyadh and drop you directly at your destination in Dubai.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long does a taxi take from Riyadh to Dubai?",
                        shortAnswer: "10-12 hours",
                        detailedAnswer: "The total driving time is around 10-12 hours. Please note that border crossing times can vary between 30 minutes to 2 hours depending on the season, weekends, and time of day.",
                        perspectives: []
                    },
                    {
                        question: "What vehicle options do you have for this route?",
                        shortAnswer: "SUVs & Sedans",
                        detailedAnswer: "We offer comfortable sedans for 1-2 passengers and premium SUVs (like GMC Yukon or Chevy Suburban) which are highly recommended for the long 1000 km journey.",
                        perspectives: []
                    },
                    {
