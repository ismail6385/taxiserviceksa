...
import { MapPin, Clock, CheckCircle2, Car, Users, DollarSign, ShoppingBag, ArrowRight, Shield } from 'lucide-react';
...
export const metadata: Metadata = {
    title: 'Dammam Airport to Salmiya Taxi | Nuwaiseeb Border Transfer | Taxi Service KSA',
    description: 'Book a private taxi from King Fahd International Airport (Dammam) to Salmiya, Kuwait via the Nuwaiseeb border. Fixed rates, door-to-door, 24/7.',
    keywords: ['Dammam Airport to Salmiya taxi', 'DMM to Salmiya taxi', 'Nuwaiseeb border Salmiya', 'Dammam Airport Salmiya transfer', 'Saudi Salmiya taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dammam-airport-to-salmiya-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to Salmiya Taxi | Fixed Price Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dammam Airport to Salmiya Taxi | Fixed Price Transfer | Taxi Service KSA',
        description: 'Direct private transfer from King Fahd International Airport (DMM) to Salmiya, Kuwait via the Nuwaiseeb border crossing.',
        url: 'https://taxiserviceksa.com/routes/dammam-airport-to-salmiya-taxi/',
        type: 'website',
    },
};

export default function DammamAirportToSalmiyaTaxiPage() {
    const routeDetails = [
        { label: 'Distance', value: '~445 km', icon: MapPin },
        ...
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                services={[
                    ...
                    { name: 'Hotel & Residence Transfers', description: 'Direct drop-off at Salmiya hotels, apartments, or malls.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Dammam Airport to Salmiya Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Nuwaiseeb Border Route
                    </span>
                }
                subtitle="Direct Transfer to Kuwait's Coastal Shopping District"
                location="Door-to-Door | Shopping & Residential | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Salmiya">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Salmiya Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Salmiya: Coastal Kuwait
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Salmiya</strong> is one of Kuwait&apos;s busiest coastal districts, known for its dense residential towers, shopping malls, beachfront promenade, and large expat community. It sits just northeast of Kuwait City along the Gulf coast.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the Nuwaiseeb border crossing, and drops you at your Salmiya apartment, hotel, or mall entrance.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <ShoppingBag className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Shopping & Malls</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off in Salmiya</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off at your Salmiya apartment, hotel, or mall entrance along the coast.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Salmiya"
                faqs={[
                    {
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to Salmiya take?',
                        shortAnswer: '4.75-5.5 Hours',
                        detailedAnswer: 'The journey covers approximately 445 kilometers via the Nuwaiseeb land border. Total time is usually 4.75 to 5.5 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you drop us at a specific mall or building in Salmiya?',
                        shortAnswer: 'Yes, door-to-door',
                        detailedAnswer: 'Yes, our service is door-to-door. Tell us your exact address, mall, or building in Salmiya and we will drop you there directly.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Salmiya Taxi
                    </h2>
                    <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                        A direct, private transfer from arrivals to the coast — no rental car, no hassle.
                    </p>
