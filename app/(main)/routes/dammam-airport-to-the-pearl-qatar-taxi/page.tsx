...
export const metadata: Metadata = {
    title: 'Dammam Airport to The Pearl-Qatar Taxi | Abu Samra Border Transfer | Taxi Service KSA',
    description: 'Book a private taxi from King Fahd International Airport (Dammam) to The Pearl-Qatar via the Abu Samra/Salwa border. Fixed rates, door-to-door, 24/7.',
    keywords: ['Dammam Airport to The Pearl Qatar taxi', 'DMM to The Pearl taxi', 'Abu Samra border The Pearl', 'Dammam Airport Pearl Qatar transfer', 'Saudi Pearl Qatar taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dammam-airport-to-the-pearl-qatar-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to The Pearl-Qatar Taxi | Fixed Price Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dammam Airport to The Pearl-Qatar Taxi | Fixed Price Transfer | Taxi Service KSA',
        description: 'Direct private transfer from King Fahd International Airport (DMM) to The Pearl-Qatar via the Abu Samra border crossing.',
        url: 'https://taxiserviceksa.com/routes/dammam-airport-to-the-pearl-qatar-taxi/',
        type: 'website',
    },
};

export default function DammamAirportToThePearlQatarTaxiPage() {
    const routeDetails = [
        { label: 'Distance', value: '~405 km', icon: MapPin },
        ...
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                services={[
                    ...
                    { name: 'Marina & Residence Transfers', description: 'Direct drop-off at Pearl-Qatar marinas, hotels, or apartments.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Dammam Airport to The Pearl-Qatar Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Abu Samra Border Route
                    </span>
                }
                subtitle="Direct Transfer to Qatar&apos;s Luxury Island"
                location="Door-to-Door | Marina & Retail District | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=The%20Pearl-Qatar">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to The Pearl-Qatar Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to The Pearl-Qatar: Luxury Island Living
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>The Pearl-Qatar</strong> is an artificial island off Doha&apos;s coast, known for its marina, high-end boutiques, waterfront dining, and luxury apartments. It&apos;s one of the most popular residential and leisure destinations for visitors to Doha.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the Abu Samra border crossing, and drops you at your Pearl-Qatar marina, hotel, or apartment.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Waves className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Marina & Waterfront</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Users className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Leisure & Family</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off at The Pearl-Qatar</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off at your marina, hotel, or apartment on the island.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to The Pearl-Qatar"
                faqs={[
                    {
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to The Pearl-Qatar take?',
                        shortAnswer: '4.25-5 Hours',
                        detailedAnswer: 'The journey covers approximately 405 kilometers via the Abu Samra/Salwa land border. Total time is usually 4.25 to 5 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you drop us at a specific marina or tower on The Pearl?',
                        shortAnswer: 'Yes, door-to-door',
                        detailedAnswer: 'Yes, our service is door-to-door. Tell us your exact marina, tower, or building on The Pearl-Qatar and we will drop you there directly.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to The Pearl-Qatar Taxi
                    </h2>
                    <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                        A direct, private transfer from arrivals to the island — no rental car, no hassle.
                    </p>
