...
export const metadata: Metadata = {
    ...
    description: 'Request a premium quote from Dammam to Kuwait. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="mailto:info@taxiserviceksa.com?text=Hello,%20I%20want%20to%20book%20a%20taxi%20from%20Dammam%20to%20Kuwait">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Dammam and Kuwait by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 400 km, and the journey typically takes 4-5 hours.
                            </p>
