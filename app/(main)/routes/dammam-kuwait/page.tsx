...
export const metadata: Metadata = {
    title: 'Taxi Dammam to Kuwait | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Dammam to Kuwait. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
    ...
    openGraph: {
        title: 'Taxi Dammam to Kuwait | VIP Cross-Border Transfer',
        description: 'Book a premium taxi from Dammam to Kuwait. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
        url: 'https://taxiserviceksa.com/routes/dammam-kuwait/',
        type: 'website',
    },
};

export default function DammamKuwaitRoutePage() {
    const images = ['/locations/kuwait.webp', '/hero-slide-3.webp', '/hero-slide-2.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Dammam to Kuwait",
        "provider": {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Dammam to Kuwait."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Dammam" toCity="Kuwait" fromSlug="dammam" toSlug="kuwait" />

            <Hero
                images={images}
                h1Text="Taxi Dammam to Kuwait"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam&dropoff=Kuwait">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Get Quote
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Dammam%20to%20Kuwait">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Dammam to Kuwait
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Dammam and Kuwait by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 400 km, and the journey typically takes 4-6 hours.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Dammam and drop you directly at your destination in Kuwait.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long does a taxi take from Dammam to Kuwait?",
