...
export const metadata: Metadata = {
    title: 'Tabuk to Al-Rass Taxi | Private Car Service 820 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Al-Rass. Reliable 8 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Al-Rass taxi', 'taxi from Tabuk to Al-Rass', 'private transfer Tabuk to Al-Rass', 'chauffeur Tabuk to Al-Rass', 'Tabuk to Al-Rass car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-al-rass/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Al-Rass Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Al-Rass Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 820 km drive. Request a quote for a comfortable ride from Tabuk to Al-Rass. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-al-rass/',
        type: 'website',
    },
};

export default function TabukAlRassRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '820 km', icon: Navigation },
        { label: 'Travel Time', value: '8 Hours', icon: Clock },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Al Rass"
                description="Professional private car service from Tabuk to Al Rass. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Al Rass Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Al Rass.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Al Rass back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="8 Hours | WhatsApp Booking | Local Drivers"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-al-rass">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Al-Rass</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Traveling from Tabuk to Al-Rass covers around 820 km, taking you through to a farming town in the Qassim region, part of the agricultural belt that supplies much of the country with dates and produce. Instead of dealing with shared transport or fixed bus schedules, our private car service handles the whole distance door-to-door.</p>
                            <p>Most people booking this route are traveling for a family or farming-related visit. The drive takes about 8 Hours, and since it's a private vehicle, the pace and stops are set around you, not a fixed timetable.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">The main advantage of booking privately is control: you set the departure time, you decide where to stop on the way to Al-Rass, and you're not sharing the vehicle with strangers. We agree the fare upfront, and our drivers are familiar with this route and its rest stops.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Al-Rass.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Al-Rass.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk Al Rass"
                faqs={[
                {
                        question: "Is Al-Rass close to Buraidah and Unaizah?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Al-Rass sits in the same Qassim farming cluster as Buraidah and Unaizah, a further stretch out from the main cities.",
                        perspectives: []
                    },
                                    {
                        question: "Can we request a specific driver who knows the Qassim area well?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Our drivers regularly cover the Qassim towns, so getting you to a specific address in Al-Rass is not a problem.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Al-Rass.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Al-Rass take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 8 Hours, covering close to 820 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                                    {
                        question: "Is the price for the whole vehicle, not per seat?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Al-Rass — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Al-Rass?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-al-rass" />
            </div>
        </div>
    );
}
