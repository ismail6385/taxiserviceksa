...
export const metadata: Metadata = {
    title: 'Tabuk to Jubail Taxi | Private Car Service 1500 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Jubail. Reliable 14-15 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Jubail taxi', 'taxi from Tabuk to Jubail', 'private transfer Tabuk to Jubail', 'chauffeur Tabuk to Jubail', 'Tabuk to Jubail car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-jubail/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Jubail Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Jubail Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1500 km drive. Request a quote for a comfortable ride from Tabuk to Jubail. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-jubail/',
        type: 'website',
    },
};

export default function TabukJubailRoutePage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Jubail"
                description="Professional private car service from Tabuk to Jubail. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Jubail Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Jubail.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Jubail back to Tabuk at competitive rates.' }
                ]}
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-jubail">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Jubail</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>The route from Tabuk to Jubail runs roughly 1500 km, ending in a major industrial and petrochemical port city on the Gulf coast, one of the largest industrial cities in the Eastern Province. We keep the trip simple: one private vehicle, one driver, and a fixed price agreed before you leave.</p>
                            <p>This route is popular with travelers going for business travel tied to the petrochemical industry. Figure on roughly 14-15 Hours in the car, with the driver stopping for meals or prayer whenever you ask, not on a fixed schedule.</p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Jubail.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Jubail.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Jubail"
                faqs={[
                {
                        question: "Can the driver drop us at an industrial site or company gate in Jubail?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, just provide the site name or gate number in advance and we will confirm the exact drop-off.",
                        perspectives: []
                    },
                                    {
                        question: "Is this route commonly used for business travel?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Given Jubail's industrial base, we do get a fair number of business travelers on this route.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Jubail.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Jubail take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 14-15 Hours, covering close to 1500 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                                    {
                        question: "Is the price for the whole vehicle, not per seat?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Jubail — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Jubail?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-jubail" />
            </div>
        </div>
    );
}
