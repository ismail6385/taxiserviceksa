                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Heading out from Tabuk to Dariya? Our private car service gets you there reliably. We focus on direct trips across Saudi Arabia for families and professionals. You can skip the crowded buses and long waits. We pick you up right from your door in Tabuk and drive you straight to your destination in Dariya. It is a straightforward way to travel without the usual stress of finding transport.</p>
                            <p>A long journey of 1250 km requires a dependable vehicle. We maintain our fleet specifically for these intercity routes. Every car is cleaned thoroughly before we pick you up in Tabuk, ensuring a fresh environment for your ride to Dariya.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                    ...
                    {
                        question: "How long is the drive from Tabuk to Dariya?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 12 Hours. The distance is close to 1250 km. We use the main highways and keep a steady pace to get you there on time.",
                        perspectives: []
                    },
                    {
                        question: "Is the price for the whole car?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to Dariya.",
                        perspectives: []
                    },
                    {
