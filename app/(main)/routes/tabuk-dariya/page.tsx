...
export const metadata: Metadata = {
    title: 'Tabuk to Dariya Taxi | Private Car Service 1250 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Dariya. Reliable 12 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Dariya taxi', 'taxi from Tabuk to Dariya', 'private transfer Tabuk to Dariya', 'chauffeur Tabuk to Dariya', 'Tabuk to Dariya car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-dariya/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Dariya Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Dariya Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1250 km drive. Request a quote for a comfortable ride from Tabuk to Dariya. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-dariya/',
        type: 'website',
    },
};

export default function TabukDariyaRoutePage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service from Tabuk to Dariya. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-dariya">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Dariya</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Tabuk to Dariya is a 1250 km journey to Diriyah, the birthplace of the first Saudi state and home to the UNESCO-listed At-Turaif heritage district just outside Riyadh. Rather than juggling shared taxis or waiting on a bus timetable, we pick you up directly and take you the whole way in a private vehicle.</p>
                            <p>Whether you're heading to Dariya for a heritage visit to At-Turaif and the historic Diriyah district, we collect you from your address in Tabuk and take you straight to your exact destination — no transfers, no waiting at a station. Expect around 12 Hours on the road, with breaks whenever you need them.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">We check every vehicle before it leaves Tabuk — tires, air conditioning, and fuel — so a long drive to Dariya doesn't turn into a breakdown story. The price you're quoted is the price you pay, and the driver will stop for food, prayer, or a stretch whenever you need it, not on a fixed schedule.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Dariya.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Dariya.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Dariya"
                faqs={[
                {
                        question: "Can the driver take us straight to At-Turaif?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, we can drop you directly at the At-Turaif district or your hotel in the Diriyah area.",
                        perspectives: []
                    },
                                    {
                        question: "Is Diriyah far from central Riyadh?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Diriyah sits on the edge of Riyadh, a short distance from the city center — we take you straight there without needing a separate transfer.",
                        perspectives: []
                    },
                                    {
                        question: "Can I book a pickup in Tabuk at night or very early morning?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. We run this route 24/7, so an early morning or late night departure from Tabuk for Dariya can be arranged.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Dariya.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Dariya take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 12 Hours, covering close to 1250 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Dariya?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-dariya" />
            </div>
        </div>
    );
}
