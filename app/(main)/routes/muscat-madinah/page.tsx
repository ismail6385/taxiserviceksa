                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Muscat to Madinah covers approximately 2,175 km, at around 21.5 hours of driving. We plan this honestly as a two-day journey with a scheduled overnight stop, not a single exhausting push.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Many clients on this route are performing Ziyarat before their Umrah, or Omani family groups combining a Madinah visit with a wider Saudi trip. Drivers on this route are Muslim and familiar with Madinah's Haram-area drop-off points.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~2,175 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                ...
                <TravelConsensus
                        ...
                        points={[
                            ...
                            },
                            {
                                ...
                                reality: "At 2,175 km and around 21.5 hours, we don't book this as a single push — we plan a proper overnight stop so pilgrims arrive rested for their first visit to the mosque, not exhausted.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    ...
                    },
                    {
                        ...
                        detailedAnswer: "At around 21.5 hours and 2,175 km, we plan this as a two-day journey with a scheduled overnight stop so you arrive rested rather than exhausted after a very long drive.",
                        perspectives: []
                    },
                    {
