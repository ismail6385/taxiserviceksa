...
export const metadata: Metadata = {
    title: 'Sharjah to Jeddah Taxi | Cross-Border Transfer | Taxi Service KSA',
    description: 'Request a premium quote from Sharjah to Jeddah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
    keywords: ['Taxi Sharjah to Jeddah', 'Sharjah to Jeddah transfer', 'cross border taxi Saudi Arabia', 'VIP transport Sharjah Jeddah'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/sharjah-jeddah/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Sharjah to Jeddah Taxi | Cross-Border Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Sharjah to Jeddah Taxi | Cross-Border Transfer | Taxi Service KSA',
        description: 'Request a premium quote from Sharjah to Jeddah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
        url: 'https://taxiserviceksa.com/routes/sharjah-jeddah/',
        type: 'website',
    },
};

export default function SharjahJeddahRoutePage() {
    const images = [
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
        '/jeddah-airport.webp'
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Sharjah to Jeddah"
                description="Professional private car service for Sharjah to Jeddah. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
                    { name: 'Sharjah to Jeddah Taxi', description: 'Premium private transfer with guaranteed fixed rates.' },
            ...
            <Hero
                images={images}
                h1Text="Sharjah to Jeddah Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Sharjah to Jeddah"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Sharjah&dropoff=Jeddah">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            WhatsApp Booking
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Sharjah%20to%20Jeddah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Sharjah to Jeddah covers approximately 2,040 km, at around 21 hours of driving. We're upfront about this: it is not a one-day trip. We plan it as a two-day journey with a scheduled overnight stop, not a single marathon drive.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~21 hours Journey</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Building2 className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">~2,040 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We plan a proper hotel stop roughly midway, rather than expecting one driver to cover 21 hours straight.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                <TravelConsensus
                        contextName="Sharjah to Jeddah"
                        points={[
                            {
                                topic: "Is This Really Driveable in One Day?",
                                commonBelief: "A long enough drive can always be pushed through in one day.",
                                reality: "At 2,040 km, we don't offer this as a single non-stop drive — fatigue risk on a 21-hour route is real, so we build in a planned overnight stop rather than pretending it's a long day trip.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="sharjah" currentSlug="sharjah-jeddah" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "Is Sharjah to Jeddah a one-day or two-day trip?",
                        shortAnswer: "Two days, with a planned overnight stop",
                        detailedAnswer: "At around 21 hours and 2,040 km, we plan this as a two-day journey with a scheduled overnight hotel stop roughly midway, rather than one driver attempting it non-stop.",
                        perspectives: []
                    },
                    {
