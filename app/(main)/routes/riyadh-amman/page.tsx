...
export const metadata: Metadata = {
    title: 'Riyadh to Amman Taxi | Cross-Border Transfer | Taxi Service KSA',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service for Riyadh to Amman. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
            ...
            <Hero
                ...
                subtitle="Seamless Transfers: Riyadh to Amman"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/966563573531?text=Hello,%20I%20want%20to%20book%20a%20taxi%20from%20Riyadh%20to%20Amman">
