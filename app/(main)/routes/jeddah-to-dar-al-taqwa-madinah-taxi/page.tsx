...
export const metadata: Metadata = {
    ...
    description: 'Request a quote for a luxury taxi from Jeddah Airport (JED) to Dar Al Taqwa Hotel Madinah. Professional drivers, fixed rates, and service to the Haram doorstep.',
