                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Your trip from Tabuk to Tanuma starts with a punctual pickup. We understand that long-distance travel requires a vehicle you can trust. Our fleet is ready to take you across the 1380 km between these cities in complete privacy. No sharing with strangers, just a direct drive from your Tabuk location to your drop-off point in Tanuma.</p>
                            <p>From the northern borders down towards Tanuma, our service bridges the gap for those who prefer private travel. We avoid the busy terminals and give you a direct route that saves you hours of waiting and multiple transfers.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                        ...
                        detailedAnswer: "Yes. Just provide your location in Tabuk, and our driver will meet you there to take you directly to Tanuma.",
                        perspectives: []
                    },
                    {
                        question: "Is the price for the whole car?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to Tanuma.",
                        perspectives: []
                    },
                    {
                    ...
                    {
                        question: "How long is the drive from Tabuk to Tanuma?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 14 Hours. The distance is close to 1380 km. We use the main highways and keep a steady pace to get you there on time.",
                        perspectives: []
                    },
                    {
