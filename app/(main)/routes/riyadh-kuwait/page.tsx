...
export const metadata: Metadata = {
    title: 'Taxi Riyadh to Kuwait | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Riyadh to Kuwait. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function RiyadhKuwaitRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Riyadh to Kuwait."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Riyadh" toCity="Kuwait" fromSlug="riyadh" toSlug="kuwait" />

            <Hero
                images={images}
                h1Text="Taxi Riyadh to Kuwait"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Riyadh%20to%20Kuwait">
