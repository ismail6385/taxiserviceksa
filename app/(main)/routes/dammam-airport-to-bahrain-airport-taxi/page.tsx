...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service from Dammam Airport to Bahrain Airport | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Professional private car service from King Fahd International Airport (Dammam) to Bahrain International Airport via King Fahd Causeway."
                services={[
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <PricingTable
                    title="Fixed Rates: Dammam Airport to Bahrain Airport"
