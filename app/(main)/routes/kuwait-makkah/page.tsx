                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~1,650 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">For larger Umrah groups travelling together, we coordinate multiple vehicles departing Kuwait on the same schedule.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        points={[
                            {
                                ...
                                reality: "Pilgrims must enter Ihram at or before the Meeqat boundary for their route — our drivers know exactly where this is on the Kuwait-Makkah road and will stop there on request.",
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: "Pilgrims travelling from Kuwait typically enter Ihram at Qarn al-Manazil or Dhul Hulaifah depending on the exact route taken — tell your driver you need a Meeqat stop when booking and they'll plan accordingly.",
                        perspectives: []
                    },
                    {
                    ...
                    },
                    {
                        ...
                        shortAnswer: "Yes",
                        detailedAnswer: "Yes, for larger groups we can coordinate several vehicles departing Kuwait on the same schedule so everyone arrives together.",
                        perspectives: []
                    }
                ]}
            />
