...
export const metadata: Metadata = {
    title: 'Dammam Airport to Manama Taxi | King Fahd Causeway Transfer | Taxi Service KSA',
    ...
    openGraph: {
        title: 'Dammam Airport to Manama Taxi | King Fahd Causeway | Taxi Service KSA',
        description: 'Private VIP transfer from Dammam Airport to Manama, the capital of Bahrain, via King Fahd Causeway.',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Professional VIP private car service from Dammam Airport to Manama, Bahrain via King Fahd Causeway. Reliable 24/7 door-to-door transfers."
                services={[
            ...
            <Hero
                ...
                h1Text="Dammam Airport to Manama Taxi"
                title={
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: 'A private sedan (like a Toyota Camry) or VIP SUV (like a GMC Yukon) is available at a fixed rate for the Dammam Airport to Manama route. Contact us on WhatsApp for a fixed quote based on your vehicle and group size.',
                        perspectives: [],
                    },
                    {
