...
export const metadata: Metadata = {
    title: 'Taxi Muscat to Makkah | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Muscat to Makkah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function MuscatMakkahRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Muscat to Makkah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Muscat" toCity="Makkah" fromSlug="muscat" toSlug="makkah" />

            <Hero
                images={images}
                h1Text="Taxi Muscat to Makkah"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless VIP Transfers: Muscat to Makkah"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Muscat%20to%20Makkah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Muscat to Makkah
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Muscat and Makkah by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 2496 km, and the journey typically takes 24-26 hours.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Muscat and drop you directly at your destination in Makkah.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long does a taxi take from Muscat to Makkah?",
