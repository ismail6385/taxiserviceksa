...
export const metadata: Metadata = {
    ...
    description: 'Request a premium quote from Jeddah to Dubai. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Jeddah to Dubai Taxi | Cross-Border Transfer | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service for Jeddah to Dubai. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
            ...
            <Hero
                images={images}
                h1Text="Jeddah to Dubai Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Jeddah to Dubai"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="mailto:info@taxiserviceksa.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Jeddah%20to%20Dubai">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="jeddah" currentSlug="jeddah-dubai" />
            </div>
