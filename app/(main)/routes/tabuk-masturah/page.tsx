...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Masturah Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
...
export default function TabukMasturahRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '750 km', icon: Navigation },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Masturah"
                description="Professional private car service from Tabuk to Masturah. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Masturah Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Masturah.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Masturah back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="7-8 Hours | WhatsApp Booking | Local Drivers"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-masturah">
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Masturah.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Masturah.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Masturah?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-masturah" />
            </div>
        </div>
    );
}
