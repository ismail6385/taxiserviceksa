...
export const metadata: Metadata = {
    title: 'Tabuk to Bareq Taxi | Private Car Service 1450 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Bareq. Reliable 14-15 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Bareq taxi', 'taxi from Tabuk to Bareq', 'private transfer Tabuk to Bareq', 'chauffeur Tabuk to Bareq', 'Tabuk to Bareq car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-bareq/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Bareq Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Bareq Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1450 km drive. Request a quote for a comfortable ride from Tabuk to Bareq. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-bareq/',
        type: 'website',
    },
};

export default function TabukBareqRoutePage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Bareq"
                description="Professional private car service from Tabuk to Bareq. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Bareq Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Bareq.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Bareq back to Tabuk at competitive rates.' }
                ]}
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-bareq">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Bareq</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Tabuk to Bareq is a 1450 km journey to a mountain town in the Asir region. Rather than juggling shared taxis or waiting on a bus timetable, we pick you up directly and take you the whole way in a private vehicle.</p>
                            <p>Whether you're heading to Bareq for a family or scenic mountain trip, we collect you from your address in Tabuk and take you straight to your exact destination — no transfers, no waiting at a station. Expect around 14-15 Hours on the road, with breaks whenever you need them.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">We check every vehicle before it leaves Tabuk — tires, air conditioning, and fuel — so a long drive to Bareq doesn't turn into a breakdown story. The price you're quoted is the price you pay, and the driver will stop for food, prayer, or a stretch whenever you need it, not on a fixed schedule.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Bareq.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Bareq.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Bareq"
                faqs={[
                {
                        question: "Is Bareq in a mountainous area like Abha?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Bareq sits within the wider Asir mountain region, so expect a similar cooler, elevated climate to Abha once you arrive.",
                        perspectives: []
                    },
                                    {
                        question: "Can we stop overnight partway if the drive is too long?",
                        shortAnswer: "Verified",
                        detailedAnswer: "If you prefer to break a long trip into two days, let us know when booking and we can discuss options.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Bareq take?",
                        shortAnswer: "Verified",
                        ...
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Bareq — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                                    {
                        question: "Do I pay extra for luggage on this trip?",
                        shortAnswer: "Verified",
                        detailedAnswer: "No. As long as your bags fit in the vehicle you booked, there is no extra charge for luggage on the way to Bareq.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Bareq?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-bareq" />
            </div>
        </div>
    );
}
