...
export const metadata: Metadata = {
    title: 'Dammam Airport to Al Khor Taxi | Abu Samra Border Transfer | Taxi Service KSA',
    description: 'Book a private taxi from King Fahd International Airport (Dammam) to Al Khor, Qatar via the Abu Samra/Salwa border. Fixed rates, door-to-door, 24/7.',
    keywords: ['Dammam Airport to Al Khor taxi', 'DMM to Al Khor taxi', 'Abu Samra border Al Khor', 'Dammam Airport Al Khor transfer', 'Saudi Al Khor taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dammam-airport-to-al-khor-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to Al Khor Taxi | Fixed Price Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dammam Airport to Al Khor Taxi | Fixed Price Transfer | Taxi Service KSA',
        description: 'Direct private transfer from King Fahd International Airport (DMM) to Al Khor, Qatar via the Abu Samra border crossing.',
        url: 'https://taxiserviceksa.com/routes/dammam-airport-to-al-khor-taxi/',
        type: 'website',
    },
};

export default function DammamAirportToAlKhorTaxiPage() {
    const routeDetails = [
        ...
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                services={[
                    ...
                    { name: 'Hotel & Site Transfers', description: 'Direct drop-off at Al Khor, Ras Laffan, or Al Khor Park.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Dammam Airport to Al Khor Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Abu Samra Border Route
                    </span>
                }
                subtitle="Direct Transfer to Qatar's Northern Industrial City"
                location="Door-to-Door | Ras Laffan & Fishing Heritage | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Al%20Khor">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Al Khor Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Al Khor: Qatar&apos;s North
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Al Khor</strong> is a coastal city north of Doha, historically known for fishing and pearling, and now home to the Ras Laffan Industrial City, Qatar&apos;s major LNG hub. It&apos;s the furthest north of our Qatar destinations, past Doha and Lusail.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the Abu Samra border crossing, and drops you at your Al Khor hotel, work site, or Al Khor Park.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Factory className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">LNG & Industrial</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">A desert highway drive south to the Salwa/Abu Samra land border, then north past Doha to Al Khor.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shrink-0 shadow-sm text-primary font-bold">3</div>
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off in Al Khor</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off at your hotel, work site, or Al Khor Park.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Al Khor"
                faqs={[
                    {
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to Al Khor take?',
                        shortAnswer: '4.5-5.25 Hours',
                        detailedAnswer: 'The journey covers approximately 430 kilometers via the Abu Samra/Salwa land border, continuing north past Doha. Total time is usually 4.5 to 5.25 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you take us to Ras Laffan Industrial City?',
                        shortAnswer: 'Yes',
                        detailedAnswer: 'Yes, we serve both Al Khor town and the nearby Ras Laffan Industrial City. Tell us your exact destination when booking.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Al Khor Taxi
                    </h2>
                    <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                        A direct, private transfer from arrivals to Al Khor — no rental car, no hassle.
                    </p>
