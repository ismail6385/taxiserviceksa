...
export const metadata: Metadata = {
    title: 'Dammam Airport to Doha Taxi | Abu Samra Border Transfer | Taxi Service KSA',
    description: 'Book a private taxi from King Fahd International Airport (Dammam) to Doha, Qatar via the Abu Samra/Salwa border. Fixed rates, door-to-door, 24/7.',
    keywords: ['Dammam Airport to Doha taxi', 'DMM to Doha taxi', 'Abu Samra border taxi', 'Dammam Airport Qatar transfer', 'Saudi Doha taxi'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dammam-airport-to-doha-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to Doha Taxi | Fixed Price Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dammam Airport to Doha Taxi | Fixed Price Transfer | Taxi Service KSA',
        description: 'Direct private transfer from King Fahd International Airport (DMM) to Doha, Qatar via the Abu Samra border crossing.',
        url: 'https://taxiserviceksa.com/routes/dammam-airport-to-doha-taxi/',
        type: 'website',
    },
};

export default function DammamAirportToDohaTaxiPage() {
    const routeDetails = [
        { label: 'Distance', value: '~400 km', icon: MapPin },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                cityName="Dammam Airport to Doha"
                description="Professional private car service from Dammam Airport to Doha, Qatar via the Abu Samra/Salwa border. Reliable 24/7 door-to-door transfers."
                services={[
                    { name: 'Dammam Airport to Doha Taxi', description: 'Private transfer to Doha via the Abu Samra border.' },
                    { name: 'Executive Chauffeur', description: 'Professional drivers for business meetings in West Bay.' },
                    { name: 'Family Van Service', description: 'Spacious vehicles for families with luggage.' },
                    { name: 'Hotel & Airport Transfers', description: 'Drop-off at Doha hotels or Hamad International Airport.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Dammam Airport to Doha Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Abu Samra Border Route
                    </span>
                }
                subtitle="Direct Transfer to Qatar's Capital"
                location="Door-to-Door | Business & Corniche | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Doha">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Doha Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Doha: Qatar&apos;s Capital
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Doha</strong> is Qatar&apos;s capital and business hub, home to the West Bay skyline, the Corniche waterfront, the Museum of Islamic Art, and Souq Waqif. Unlike Bahrain, Qatar is a peninsula with no causeway — the journey crosses the desert to the Abu Samra land border, south of the city.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the border crossing, and drops you at your Doha hotel, office, or the Corniche.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Building2 className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Business & West Bay</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    <Users className="w-6 h-6 text-primary" />
                                    <span className="font-semibold text-gray-800">Family & Tourism</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Direct drop-off at your Doha hotel, office, or the West Bay/Corniche area.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href="/routes/dammam-doha/" className="bg-white px-4 py-2 rounded-lg border border-gray-200 text-sm hover:border-emerald-500 hover:text-emerald-700 transition-colors shadow-sm">
                            Dammam to Doha (Overview)
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Doha"
                faqs={[
                    {
                        question: 'How much is a taxi from Dammam Airport to Doha?',
                        shortAnswer: 'WhatsApp Booking',
                        detailedAnswer: 'A private sedan or SUV (like a GMC Yukon) is available at a fixed rate for the Dammam Airport to Doha route. Contact us on WhatsApp for a fixed quote based on your vehicle and group size.',
                        perspectives: [],
                    },
                    {
                        question: 'How long does the drive from Dammam Airport to Doha take?',
                        shortAnswer: '4-4.75 Hours',
                        detailedAnswer: 'The journey covers approximately 400 kilometers via the Abu Samra/Salwa land border. Total time is usually 4 to 4.75 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Do I need a visa for Qatar?',
                        shortAnswer: 'Yes, check requirements first',
                        detailedAnswer: 'GCC nationals cross with a valid GCC ID. Other nationalities need a valid Qatar visa or e-visa arranged before travel — please confirm your visa status before booking.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Doha Taxi
                    </h2>
