    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Professional private car service from Dammam Airport to Muharraq, Bahrain via King Fahd Causeway. Reliable 24/7 door-to-door transfers."
                services={[
            ...
            <Hero
                ...
                h1Text="Private Car, Taxi and Chauffeur Service from Dammam Airport to Muharraq"
                title={
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <PricingTable
                    title="Fixed Rates: Dammam Airport to Muharraq"
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href="/routes/muharraq-to-dammam-airport-taxi/" className="bg-white px-4 py-2 rounded-lg border border-gray-200 text-sm hover:border-emerald-500 hover:text-emerald-700 transition-colors shadow-sm">
                            Muharraq to Dammam Airport (Return)
                        </Link>
                    </div>
                </div>
            </div>
