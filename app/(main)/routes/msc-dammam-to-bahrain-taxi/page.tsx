...
export const metadata: Metadata = {
    title: "MSC Dammam to Bahrain VIP Taxi | Corporate Executive Transfer | Taxi Service KSA",
    description: "VIP taxi and executive chauffeur service from Dammam, Al Khobar and Dhahran to Bahrain for MSC staff, contractors and visiting professionals. King Fahd Causeway, fixed corporate rates, invoicing on request.",
    keywords: ["MSC Dammam to Bahrain taxi","MSC Dammam Bahrain transfer","MSC corporate taxi Dammam","Dammam to Bahrain VIP taxi","King Fahd Causeway executive transfer"],
    alternates: {
...
export default function MscDammamToBahrainTaxiPage() {
    const company = getCorporateBahrainTransfer("msc")!;
