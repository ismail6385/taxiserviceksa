                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Booking a private car from Tabuk to AlUla is the most convenient way to handle the 330 km journey. Avoid the hassle of shared taxis or fixed bus routes. We provide a door-to-door service that caters to your specific needs. Whether you are traveling for a family visit or a business commitment in AlUla, our chauffeurs ensure a smooth ride on the open road.</p>
                            <p>We take pride in being reliable. A 330 km drive is quite a distance, so we make sure the cars are in top shape. Our team checks every vehicle before the trip to ensure the AC works perfectly and the tires are good for the highway.</p>
                        </div>
                    </div>
                ...
                faqs={[
{
                        ...
                        detailedAnswer: "It usually takes about 3.5-4 Hours. The distance is close to 330 km. We use the main highways and keep a steady pace to get you there on time.",
                        perspectives: []
                    },
                    {
                        question: "How do I Request a quote for a pickup in Tabuk?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. Just provide your location in Tabuk, and our driver will meet you there to take you directly to AlUla.",
                        perspectives: []
                    },
                    {
                    ...
                    },
                    {
                        ...
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we give you is for the private vehicle and driver. You don't share the ride with strangers on your way to AlUla.",
                        perspectives: []
                    },
                    {
