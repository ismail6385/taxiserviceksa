                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Sharjah to Riyadh
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Sharjah and Riyadh by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 1149 km, and the journey typically takes 11-13 hours.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">11-13 hours Journey</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Sharjah and drop you directly at your destination in Riyadh.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                ...
                faqs={[
                    {
                        ...
                        shortAnswer: "11-13 hours",
                        detailedAnswer: "The total driving time is around 11-13 hours. Please note that border crossing times can vary between 30 minutes to 2 hours depending on the season, weekends, and time of day.",
                        perspectives: []
                    },
                    {
                        question: "What vehicle options do you have for this route?",
                        shortAnswer: "SUVs & Sedans",
                        detailedAnswer: "We offer comfortable sedans for 1-2 passengers and premium SUVs (like GMC Yukon or Chevy Suburban) which are highly recommended for the long 1149 km journey.",
                        perspectives: []
                    },
                    {
