...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dammam Airport to Al Wakrah Taxi | Fixed Price Transfer | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Professional private car service from Dammam Airport to Al Wakrah, Qatar via the Abu Samra/Salwa border. Reliable 24/7 door-to-door transfers."
                services={[
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: 'A private sedan or SUV (like a GMC Yukon) is available at a fixed rate for the Dammam Airport to Al Wakrah route. Contact us on WhatsApp for a fixed quote based on your vehicle and group size.',
                        perspectives: [],
                    },
                    {
