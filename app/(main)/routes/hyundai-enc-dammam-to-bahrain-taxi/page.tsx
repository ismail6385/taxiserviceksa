...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Hyundai Engineering & Construction Dammam to Bahrain VIP Taxi | Taxi Service KSA' }],
