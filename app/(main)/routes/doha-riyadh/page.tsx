...
export const metadata: Metadata = {
    ...
    description: 'Book a premium taxi from Doha to Riyadh. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function DohaRiyadhRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Doha to Riyadh."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Doha" toCity="Riyadh" fromSlug="doha" toSlug="riyadh" />
            ...
            <Hero
                ...
                subtitle="Seamless VIP Transfers: Doha to Riyadh"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Doha%20to%20Riyadh">
