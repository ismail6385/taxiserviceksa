...
export const metadata: Metadata = {
    ...
    description: 'Book a premium taxi from Abu Dhabi to Madinah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function AbuDhabiMadinahRoutePage() {
    ...
    const routeSchema = {
        ...
        "@type": "Service",
        "name": "Taxi Abu Dhabi to Madinah",
        "provider": {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Abu Dhabi to Madinah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-abu-dhabi-madinah"
            ...
            <RouteBreadcrumb fromCity="Abu Dhabi" toCity="Madinah" fromSlug="abu-dhabi" toSlug="madinah" />
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Abu Dhabi%20to%20Madinah">
