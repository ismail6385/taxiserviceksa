                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Abu Dhabi to Madinah covers approximately 1,790 km — at around 18 hours of driving, one of the longest routes we operate. We plan this honestly as a two-day journey with a scheduled overnight stop, not a single exhausting push.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~1,790 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Rather than an 18-hour non-stop push, we build in a proper overnight rest roughly midway.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                ...
                <TravelConsensus
                        ...
                        points={[
                            ...
                            },
                            {
                                ...
                                reality: "At 1,790 km and around 18 hours, we don't book this as a single push — we plan a proper overnight stop so pilgrims arrive rested for their first visit to the mosque, not exhausted.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    ...
                    },
                    {
                        ...
                        detailedAnswer: "At around 18 hours and 1,790 km, we plan this as a two-day journey with a scheduled overnight stop so you arrive rested rather than exhausted after a very late-night drive.",
                        perspectives: []
                    },
                    {
