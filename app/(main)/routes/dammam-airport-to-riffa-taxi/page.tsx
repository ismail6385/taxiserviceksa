...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service from Dammam Airport to Riffa | Taxi Service KSA' }],
...
export default function DammamToRiffaTaxiPage() {
    const routeDetails = [
        ...
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                services={[
                    ...
                    { name: 'Hotel & Residence Transfers', description: 'Direct drop-off at Riffa homes, hotels, or offices.' },
                ]}
            ...
            <Hero
                ...
                subtitle="Direct Transfer to Bahrain&apos;s Second City"
                location="Door-to-Door | Family & Residential | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Riffa">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Riffa Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Riffa: A Quieter Side of Bahrain
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Riffa</strong> is Bahrain&apos;s second-largest city, known for its residential neighbourhoods, golf courses, and the historic Riffa Fort. It sits further inland than Manama, so the drive from Dammam continues a little past the capital once you cross the causeway.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the causeway crossing, and drops you directly at your home, hotel, or office in Riffa — a comfortable option for families and residents alike.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off in Riffa</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off to your Riffa home, hotel, or office, past the capital.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Riffa"
                faqs={[
                    {
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to Riffa take?',
                        shortAnswer: '1.75-2.25 Hours',
                        detailedAnswer: 'The journey covers approximately 90 kilometers, including the drive to the causeway, the 25km King Fahd Causeway crossing, and the drive on past Manama to Riffa. Total time is usually 1.75 to 2.25 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Is Riffa far from Manama?',
                        shortAnswer: 'About 15km further',
                        detailedAnswer: 'Riffa sits roughly 15km south of Manama, so the drive from Dammam takes slightly longer than a Dammam Airport to Manama trip. We can also route through Manama first if you have stops to make.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Riffa Taxi
                    </h2>
