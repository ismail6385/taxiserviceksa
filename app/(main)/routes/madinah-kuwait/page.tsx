...
export const metadata: Metadata = {
    title: 'Madinah to Kuwait Taxi | Cross-Border Transfer | Taxi Service KSA',
    description: 'Request a premium quote from Madinah to Kuwait. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
    keywords: ['Taxi Madinah to Kuwait', 'Madinah to Kuwait transfer', 'cross border taxi Saudi Arabia', 'VIP transport Madinah Kuwait'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/madinah-kuwait/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Madinah to Kuwait Taxi | Cross-Border Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Madinah to Kuwait Taxi | Cross-Border Transfer | Taxi Service KSA',
        description: 'Request a premium quote from Madinah to Kuwait. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
        url: 'https://taxiserviceksa.com/routes/madinah-kuwait/',
        type: 'website',
    },
};

export default function MadinahKuwaitRoutePage() {
    const images = [
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
        '/jeddah-airport.webp'
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Madinah to Kuwait"
                description="Professional private car service for Madinah to Kuwait. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
                    { name: 'Madinah to Kuwait Taxi', description: 'Premium private transfer with guaranteed fixed rates.' },
            ...
            <Hero
                images={images}
                h1Text="Madinah to Kuwait Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Madinah to Kuwait"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Madinah&dropoff=Kuwait">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            WhatsApp Booking
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Madinah%20to%20Kuwait">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Madinah to Kuwait
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Madinah and Kuwait by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 1290 km, and the journey typically takes 12-14 hours.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">12-14 hours Journey</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Madinah and drop you directly at your destination in Kuwait.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="madinah" currentSlug="madinah-kuwait" />
            </div>

            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long does a taxi take from Madinah to Kuwait?",
                        shortAnswer: "12-14 hours",
                        detailedAnswer: "The total driving time is around 12-14 hours. Please note that border crossing times can vary between 30 minutes to 2 hours depending on the season, weekends, and time of day.",
                        perspectives: []
                    },
                    {
                        question: "What vehicle options do you have for this route?",
                        shortAnswer: "SUVs & Sedans",
                        detailedAnswer: "We offer comfortable sedans for 1-2 passengers and premium SUVs (like GMC Yukon or Chevy Suburban) which are highly recommended for the long 1290 km journey.",
                        perspectives: []
                    },
                    {
