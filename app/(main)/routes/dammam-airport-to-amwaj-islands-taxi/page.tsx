    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                ...
                description="Professional VIP private car service from Dammam Airport to Amwaj Islands, Bahrain via King Fahd Causeway. Reliable 24/7 door-to-door transfers."
                services={[
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: 'A private sedan (like a Toyota Camry) or VIP SUV (like a GMC Yukon) is available at a fixed rate for the Dammam Airport to Amwaj Islands route. Contact us on WhatsApp for a fixed quote based on your vehicle and group size.',
                        perspectives: [],
                    },
                    {
