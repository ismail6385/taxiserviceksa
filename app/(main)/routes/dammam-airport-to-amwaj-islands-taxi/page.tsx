...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service from Dammam Airport to Amwaj Islands | Taxi Service KSA' }],
...
export default function DammamToAmwajIslandsTaxiPage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                cityName="Dammam Airport to Amwaj Islands"
                description="Professional private car service from Dammam Airport to Amwaj Islands, Bahrain via King Fahd Causeway. Reliable 24/7 door-to-door transfers."
                services={[
                    { name: 'Dammam Airport to Amwaj Islands Taxi', description: 'Private transfer to Bahrain\'s resort islands via the causeway.' },
                    { name: 'Executive Chauffeur', description: 'Professional drivers for weekend and leisure trips.' },
                    { name: 'Family Van Service', description: 'Spacious vehicles for families with beach luggage.' },
                    { name: 'Resort & Villa Transfers', description: 'Direct drop-off at Amwaj resorts, restaurants, and villas.' },
                ]}
            ...
            <Hero
                ...
                subtitle="Direct Transfer to Bahrain&apos;s Beach & Resort Islands"
                location="Door-to-Door | Weekend Getaway | 24/7"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam%20Airport&dropoff=Amwaj%20Islands">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Dammam Airport to Amwaj Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Dammam Airport to Amwaj Islands: Bahrain&apos;s Beach Escape
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                <strong>Amwaj Islands</strong> is a cluster of man-made islands on Bahrain&apos;s northeast coast, known for its marina, waterfront restaurants, private beaches, and resort-style villas and apartments. It&apos;s a popular weekend destination for visitors from the Eastern Province.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Our private taxi service picks you up directly from King Fahd International Airport (DMM), handles the causeway crossing, and drops you directly at your Amwaj resort, restaurant, or villa — ideal for a relaxed weekend getaway without the hassle of driving yourself.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Drop-off at Amwaj</h4>
                                        <p className="text-sm text-gray-500">Direct drop-off at your Amwaj resort, restaurant, or villa on the northeast coast.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <PricingTable
                    title="Fixed Rates: Dammam Airport to Amwaj Islands"
            ...
            <MicroSemanticFAQ
                contextName="Dammam Airport to Amwaj Islands"
                faqs={[
                    {
                        question: 'How much is a taxi from Dammam Airport to Amwaj Islands?',
                    ...
                    {
                        question: 'How long does the drive from Dammam Airport to Amwaj Islands take?',
                        shortAnswer: '1.75-2 Hours',
                        detailedAnswer: 'The journey covers approximately 85 kilometers, including the drive to the causeway, the 25km King Fahd Causeway crossing, and the drive on to the Amwaj Islands on Bahrain\'s northeast coast. Total time is usually 1.75 to 2 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you also arrange a return trip the same day?',
                        shortAnswer: 'Yes',
                        detailedAnswer: 'Yes, many visitors use this route for a day or weekend trip. Let us know your planned return time and we will arrange the pickup from Amwaj back to Dammam.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Dammam Airport to Amwaj Islands Taxi
                    </h2>
