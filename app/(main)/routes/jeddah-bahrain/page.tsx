...
export const metadata: Metadata = {
    title: 'Taxi Jeddah to Bahrain | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Jeddah to Bahrain. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function JeddahBahrainRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Jeddah to Bahrain."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-jeddah-bahrain"
            ...
            <RouteBreadcrumb fromCity="Jeddah" toCity="Bahrain" fromSlug="jeddah" toSlug="bahrain" />

            <Hero
                images={images}
                h1Text="Taxi Jeddah to Bahrain"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Jeddah%20to%20Bahrain">
