...
export const metadata: Metadata = {
    title: 'Taxi Makkah to Bahrain | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Makkah to Bahrain. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function MakkahBahrainRoutePage() {
    const images = ['/locations/bahrain.webp', '/hero-slide-3.webp', '/hero-slide-2.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Makkah to Bahrain",
        "provider": {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Makkah to Bahrain."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-makkah-bahrain"
            ...
            <RouteBreadcrumb fromCity="Makkah" toCity="Bahrain" fromSlug="makkah" toSlug="bahrain" />

            <Hero
                images={images}
                h1Text="Taxi Makkah to Bahrain"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Makkah%20to%20Bahrain">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <RelatedLocations currentCity="Bahrain" />
            </div>
