    ...
    return (
        <div className="bg-gray-50 min-h-screen">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                The Premium Way from Bahrain to Madinah
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Traveling between Bahrain and Madinah by road is a popular option for families, businessmen, and GCC residents. The distance is approximately 1453 km, and the journey typically takes 14-16 hours.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">We pick you up from your exact location in Bahrain and drop you directly at your destination in Madinah.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "How long does a taxi take from Bahrain to Madinah?",
