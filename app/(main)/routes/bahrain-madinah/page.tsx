...
export const metadata: Metadata = {
    title: 'Taxi Bahrain to Madinah | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Bahrain to Madinah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function BahrainMadinahRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Bahrain to Madinah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-bahrain-madinah"
            ...
            <RouteBreadcrumb fromCity="Bahrain" toCity="Madinah" fromSlug="bahrain" toSlug="madinah" />

            <Hero
                images={images}
                h1Text="Taxi Bahrain to Madinah"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless VIP Transfers: Bahrain to Madinah"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Bahrain%20to%20Madinah">
