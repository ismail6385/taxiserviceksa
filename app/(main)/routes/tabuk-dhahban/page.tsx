...
export const metadata: Metadata = {
    title: 'Tabuk to Dhahban Taxi | Private Car Service 980 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Dhahban. Reliable 9.5 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Dhahban taxi', 'taxi from Tabuk to Dhahban', 'private transfer Tabuk to Dhahban', 'chauffeur Tabuk to Dhahban', 'Tabuk to Dhahban car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-dhahban/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Dhahban Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Dhahban Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 980 km drive. Request a quote for a comfortable ride from Tabuk to Dhahban. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-dhahban/',
        type: 'website',
    },
};

export default function TabukDhahbanRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '980 km', icon: Navigation },
        { label: 'Travel Time', value: '9.5 Hours', icon: Clock },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Dhahban"
                description="Professional private car service from Tabuk to Dhahban. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Dhahban Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Dhahban.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Dhahban back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                location="9.5 Hours | WhatsApp Booking | Local Drivers"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-dhahban">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Dhahban</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>The route from Tabuk to Dhahban runs roughly 980 km, ending in a northern Jeddah coastal district, near the King Abdulaziz refinery and Jeddah's northern industrial area. We keep the trip simple: one private vehicle, one driver, and a fixed price agreed before you leave.</p>
                            <p>This route is popular with travelers going for business travel near Jeddah's northern industrial zone. Figure on roughly 9.5 Hours in the car, with the driver stopping for meals or prayer whenever you ask, not on a fixed schedule.</p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Dhahban.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Dhahban.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Dhahban"
                faqs={[
                {
                        question: "Is Dhahban considered part of Jeddah city?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Dhahban is on the northern edge of greater Jeddah — we take you directly there without needing to route through central Jeddah.",
                        perspectives: []
                    },
                                    {
                        question: "Can you continue into central Jeddah afterward if needed?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, if you need to continue into Jeddah city after Dhahban, let us know and we can quote that as part of the trip.",
                        perspectives: []
                    },
                                    {
                        question: "Can I book a pickup in Tabuk at night or very early morning?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. We run this route 24/7, so an early morning or late night departure from Tabuk for Dhahban can be arranged.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Dhahban.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Dhahban take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 9.5 Hours, covering close to 980 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Dhahban?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-dhahban" />
            </div>
        </div>
    );
}
