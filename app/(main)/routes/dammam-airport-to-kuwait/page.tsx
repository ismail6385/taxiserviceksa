            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 border-t border-gray-100">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-center">
                        <a href="https://wa.me/966575806733?text=Hello,%20I%20saw%20your%20journey%20video%20and%20want%20to%20book%20DMM%20to%20Kuwait%20taxi" className="inline-flex items-center gap-2 bg-emerald-600 text-white hover:bg-emerald-700 font-bold py-4 px-10 rounded-2xl shadow-xl transition-all hover:scale-105">
                    ...
                    <div className="bg-emerald-50 rounded-3xl p-8 md:p-12 border border-emerald-100 flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="w-full md:w-1/3 flex flex-col gap-6 self-start">
                            ...
                            <div className="bg-emerald-600 p-8 rounded-2xl shadow-xl text-white">
                                ...
                                <a href="https://wa.me/966575806733?text=Hello,%20I%20want%20to%20book%20a%20taxi%20from%20Dammam%20Airport%20to%20Kuwait" className="w-full bg-white text-emerald-600 hover:bg-gray-100 font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-xl">
