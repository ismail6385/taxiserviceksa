...
export const metadata: Metadata = {
    title: 'Private Car, Taxi and Chauffeur Service from Muharraq to Dammam Airport | Taxi Service KSA',
    description: 'Book a private taxi from Muharraq, Bahrain to Dammam Airport via King Fahd Causeway. Pickup from the old town, Pearling Trail, or Bahrain Airport area. Fixed rates.',
    keywords: ['Muharraq to Dammam Airport taxi', 'Muharraq to Saudi Airport taxi', 'King Fahd Causeway Muharraq to Dammam', 'Muharraq to Eastern Province transfer', 'Muharraq to Dammam Airport car'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/muharraq-to-dammam-airport-taxi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service from Muharraq to Dammam Airport | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Private Car, Taxi and Chauffeur Service from Muharraq to Dammam Airport | Taxi Service KSA',
        description: 'Private transfer from Muharraq, Bahrain\'s historic old town, to Dammam Airport via King Fahd Causeway.',
        url: 'https://taxiserviceksa.com/routes/muharraq-to-dammam-airport-taxi/',
        type: 'website',
    },
};

export default function MuharraqToDammamAirportTaxiPage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation
                cityName="Muharraq to Dammam Airport"
                description="Professional private car service from Muharraq, Bahrain to Dammam Airport via King Fahd Causeway. Reliable 24/7 door-to-door transfers."
                services={[
                    { name: 'Muharraq to Dammam Airport Taxi', description: 'Private transfer from Bahrain\'s historic old town via the causeway.' },
                    { name: 'Executive Chauffeur', description: 'Professional drivers for business travellers departing Muharraq.' },
                    { name: 'Family Van Service', description: 'Spacious vehicles for families with luggage.' },
                    { name: 'Heritage Site Pickups', description: 'Pickup from the Pearling Trail, old town, or Bahrain Airport area.' },
                ]}
            ...
            <Hero
                ...
                h1Text="Private Car, Taxi and Chauffeur Service from Muharraq to Dammam Airport"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Muharraq&dropoff=Dammam%20Airport">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            Book Muharraq to Dammam Airport Taxi
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                Muharraq to Dammam Airport for Your Flight
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Leaving <strong>Muharraq</strong> — Bahrain&apos;s historic old town and home to the Bahrain Pearling Trail — to catch a flight from <strong>King Fahd International Airport (DMM)</strong>? Our private taxi collects you directly from your hotel, heritage site, or the Bahrain Airport area, crosses the 25km King Fahd Causeway, and drops you at the Dammam Airport departures terminal.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Since Muharraq island is also home to Bahrain International Airport, this route is a convenient overland alternative when a DMM flight suits your schedule better than a BAH departure.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">Pickup in Muharraq</h4>
                                        <p className="text-sm text-gray-500">Your driver collects you from the old town, pearling trail sites, or your hotel.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <MicroSemanticFAQ
                contextName="Muharraq to Dammam Airport"
                faqs={[
                    {
                        question: 'How much is a taxi from Muharraq to Dammam Airport?',
                        shortAnswer: 'WhatsApp Booking',
                        detailedAnswer: 'A private sedan (like a Toyota Camry) or SUV (like a GMC Yukon) is available at a fixed rate for the Muharraq to Dammam Airport route. Contact us on WhatsApp for a fixed quote based on your vehicle and group size.',
                        perspectives: [],
                    },
                    {
                        question: 'How long does the drive from Muharraq to Dammam Airport take?',
                        shortAnswer: '1.5-1.75 Hours',
                        detailedAnswer: 'The journey covers approximately 70 kilometers, including the 25km King Fahd Causeway crossing and the drive on to Dammam Airport. Total time is usually 1.5 to 1.75 hours depending on border processing.',
                        perspectives: [],
                    },
                    {
                        question: 'Can you pick us up from a heritage site or hotel in Muharraq?',
                        shortAnswer: 'Yes, door-to-door',
                        detailedAnswer: 'Yes, our service is door-to-door. Tell us your exact pickup point in Muharraq — including old town hotels and Pearling Trail sites — and we will collect you there directly.',
                        perspectives: [],
                    },
                ]}
            />
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                        Book Your Muharraq to Dammam Airport Taxi
                    </h2>
