...
export const metadata: Metadata = {
    title: 'Tabuk to Baljurashi Taxi | Private Car Service 1250 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Baljurashi. Reliable 12-13 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Baljurashi taxi', 'taxi from Tabuk to Baljurashi', 'private transfer Tabuk to Baljurashi', 'chauffeur Tabuk to Baljurashi', 'Tabuk to Baljurashi car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-baljurashi/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Baljurashi Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Baljurashi Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1250 km drive. Request a quote for a comfortable ride from Tabuk to Baljurashi. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-baljurashi/',
        type: 'website',
    },
};

export default function TabukBaljurashiRoutePage() {
    const routeDetails = [
        { label: 'Distance', value: '1250 km', icon: Navigation },
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Baljurashi"
                description="Professional private car service from Tabuk to Baljurashi. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Baljurashi Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Baljurashi.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Baljurashi back to Tabuk at competitive rates.' }
                ]}
            ...
            <Hero
                ...
                h1Text="Tabuk to Baljurashi Taxi"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-baljurashi">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Baljurashi</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>The route from Tabuk to Baljurashi runs roughly 1250 km, ending in an Al-Baha mountain town known for its terraced farms and the region's traditional flower-crowned "flower men" (Qahtani) culture. We keep the trip simple: one private vehicle, one driver, and a fixed price agreed before you leave.</p>
                            <p>This route is popular with travelers going for a cultural or scenic mountain trip. Figure on roughly 12-13 Hours in the car, with the driver stopping for meals or prayer whenever you ask, not on a fixed schedule.</p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Baljurashi.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Baljurashi.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Baljurashi"
                faqs={[
                {
                        question: "Is Baljurashi known for anything specific to the region?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Baljurashi and the surrounding Al-Baha mountains are known for terraced farming and the traditional flower-crown culture of the local Qahtani communities.",
                        perspectives: []
                    },
                                    {
                        question: "Is the mountain drive comfortable for elderly passengers?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Our drivers take mountain roads at a measured pace, and we're happy to add extra stops if you're traveling with elderly passengers.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Baljurashi.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Baljurashi take?",
                        shortAnswer: "Verified",
                        detailedAnswer: "It usually takes about 12-13 Hours, covering close to 1250 km. The driver keeps a steady highway pace and adjusts for traffic or weather where needed.",
                        perspectives: []
                    },
                                    {
                        question: "Is the price for the whole vehicle, not per seat?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Baljurashi — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Baljurashi?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-baljurashi" />
            </div>
        </div>
    );
}
