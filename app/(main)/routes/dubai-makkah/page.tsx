...
export const metadata: Metadata = {
    title: 'Dubai to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA',
    description: 'Request a premium quote from Dubai to Makkah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
    keywords: ['Taxi Dubai to Makkah', 'Dubai to Makkah transfer', 'cross border taxi Saudi Arabia', 'VIP transport Dubai Makkah'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/dubai-makkah/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Dubai to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Dubai to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA',
        description: 'Request a premium quote from Dubai to Makkah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
        url: 'https://taxiserviceksa.com/routes/dubai-makkah/',
        type: 'website',
    },
};
...
export default function DubaiMakkahRoutePage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Dubai to Makkah"
                description="Professional private car service for Dubai to Makkah. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
                    { name: 'Dubai to Makkah Taxi', description: 'Premium private transfer with guaranteed fixed rates.' },
            ...
            <Hero
                images={images}
                h1Text="Dubai to Makkah Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Dubai to Makkah"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dubai&dropoff=Makkah">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            WhatsApp Booking
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Dubai%20to%20Makkah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Dubai to Makkah covers approximately 2,110 km — one of the longest routes we operate, at around 21.5 hours of driving. We plan this honestly as a two-day journey with a scheduled overnight stop, so pilgrims arrive ready for Umrah rather than exhausted.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~2,110 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                <TravelConsensus
                        contextName="Dubai to Makkah"
                        points={[
                            {
                                topic: "Meeqat Timing",
                                commonBelief: "You can enter Ihram any time before Makkah.",
                                reality: "Pilgrims must enter Ihram at or before the Meeqat boundary for their route — our drivers know exactly where this is on the Dubai-Makkah road and will stop there on request.",
                            ...
                            },
                            {
                                ...
                                reality: "At 2,110 km and around 21.5 hours, we don't book this as a single push — a scheduled overnight stop means pilgrims arrive rested and ready for Umrah, not exhausted from a marathon drive.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="dubai" currentSlug="dubai-makkah" />
            </div>
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: "Pilgrims travelling from Dubai typically enter Ihram at Qarn al-Manazil or Dhul Hulaifah depending on the exact route taken — tell your driver you need a Meeqat stop when booking and they'll plan accordingly.",
                        perspectives: []
                    },
                    {
                        question: "Is this a one-day or two-day journey?",
                        shortAnswer: "Two days, with an overnight stop",
                        detailedAnswer: "At around 21.5 hours and 2,110 km, we plan this as a two-day journey with a scheduled overnight stop so you arrive rested and ready for Umrah, not exhausted from a non-stop drive.",
                        perspectives: []
                    },
                    {
