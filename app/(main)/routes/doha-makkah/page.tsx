...
export const metadata: Metadata = {
    title: 'Doha to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA',
    description: 'Request a premium quote from Doha to Makkah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
    keywords: ['Taxi Doha to Makkah', 'Doha to Makkah transfer', 'cross border taxi Saudi Arabia', 'VIP transport Doha Makkah'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/doha-makkah/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Doha to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Doha to Makkah Taxi | Cross-Border Transfer | Taxi Service KSA',
        description: 'Request a premium quote from Doha to Makkah. Reliable cross-border transfers, comfortable SUVs, and door-to-door service across the GCC.',
        url: 'https://taxiserviceksa.com/routes/doha-makkah/',
        type: 'website',
    },
};

export default function DohaMakkahRoutePage() {
    const images = [
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
        '/jeddah-airport.webp'
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Doha to Makkah"
                description="Professional private car service for Doha to Makkah. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
                    { name: 'Doha to Makkah Taxi', description: 'Premium private transfer with guaranteed fixed rates.' },
            ...
            <Hero
                images={images}
                h1Text="Doha to Makkah Taxi"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        GCC Cross-Border Service
                    </span>
                }
                subtitle="Seamless Transfers: Doha to Makkah"
                location="Door-to-Door Service"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Doha&dropoff=Makkah">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            WhatsApp Booking
                            <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Doha%20to%20Makkah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Doha to Makkah covers approximately 1,447 km — from the Salwa border, the length of the Kingdom to the Haram — at around 14 hours of driving. This is a dedicated Umrah transfer for pilgrims who want a single private vehicle from their Doha doorstep straight to the Haram, without a connecting flight or shared transport.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <span className="font-semibold text-gray-800">~1,447 km Total</span>
                                </div>
                                <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl">
                            ...
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">For larger Umrah groups travelling together, we coordinate multiple vehicles departing Doha on the same schedule.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                <TravelConsensus
                        contextName="Doha to Makkah"
                        points={[
                            {
                                topic: "Meeqat Timing",
                                commonBelief: "You can enter Ihram any time before Makkah.",
                                reality: "Pilgrims must enter Ihram at or before the Meeqat boundary for their route — our drivers know exactly where this is on the Doha-Makkah road and will stop there on request.",
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: "Pilgrims travelling from Doha typically enter Ihram at Qarn al-Manazil or Dhul Hulaifah depending on the exact route taken — tell your driver you need a Meeqat stop when booking and they'll plan accordingly.",
                        perspectives: []
                    },
                    {
                    ...
                    },
                    {
                        ...
                        shortAnswer: "Yes",
                        detailedAnswer: "Yes, for larger groups we can coordinate several vehicles departing Doha on the same schedule so everyone arrives together.",
                        perspectives: []
                    }
                ]}
            />
