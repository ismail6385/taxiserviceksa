...
export const metadata: Metadata = {
    ...
    description: 'Book a premium taxi from Dubai to Jeddah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function DubaiJeddahRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Dubai to Jeddah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <RouteBreadcrumb fromCity="Dubai" toCity="Jeddah" fromSlug="dubai" toSlug="jeddah" />
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Dubai%20to%20Jeddah">
