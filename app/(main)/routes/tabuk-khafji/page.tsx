...
export const metadata: Metadata = {
    title: 'Tabuk to Khafji Taxi | Private Car Service 1350 km | Fixed Price | Taxi Service KSA',
    description: 'Request a quote for a private taxi from Tabuk to Khafji. Reliable 13-14 Hours drive with professional drivers. Fixed rates, door-to-door service, and comfortable SUVs for families.',
    keywords: ['Tabuk to Khafji taxi', 'taxi from Tabuk to Khafji', 'private transfer Tabuk to Khafji', 'chauffeur Tabuk to Khafji', 'Tabuk to Khafji car with driver'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/routes/tabuk-khafji/',
    },
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Tabuk to Khafji Taxi | Private Transfer - Fixed Price | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'Tabuk to Khafji Taxi | Private Transfer - Fixed Price | Taxi Service KSA',
        description: 'Reliable 1350 km drive. Request a quote for a comfortable ride from Tabuk to Khafji. Professional service available 24/7.',
        url: 'https://taxiserviceksa.com/routes/tabuk-khafji/',
        type: 'website',
    },
};

export default function TabukKhafjiRoutePage() {
    const routeDetails = [
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                cityName="Tabuk to Khafji"
                description="Professional private car service from Tabuk to Khafji. Reliable, door-to-door long-distance transport for families and business travelers."
                services={[
                    { name: 'Tabuk to Khafji Taxi', description: 'Direct 24/7 private transfer with professional chauffeurs.' },
                    { name: 'Family SUV Transfer', description: 'Spacious and safe GMC Yukons for the drive between Tabuk and Khafji.' },
                    { name: 'Long-Distance Chauffeur', description: 'Comfortable long-distance travel across Saudi Arabia with luxury vehicles.' },
                    { name: 'Return Trip Booking', description: 'Book your return journey from Khafji back to Tabuk at competitive rates.' }
                ]}
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking/?route=tabuk-khafji">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 underline decoration-primary decoration-4 underline-offset-8">Travel from Tabuk to Khafji</h2>
                        <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                            <p>Traveling from Tabuk to Khafji covers around 1350 km, taking you through to an oil town on the Gulf coast right at the Saudi–Kuwait border, at the northern end of the Eastern Province. Instead of dealing with shared transport or fixed bus schedules, our private car service handles the whole distance door-to-door.</p>
                            <p>Most people booking this route are traveling for business travel or a border-area visit. The drive takes about 13-14 Hours, and since it's a private vehicle, the pace and stops are set around you, not a fixed timetable.</p>
                    ...
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-16 text-white relative overflow-hidden mb-16">
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed">The main advantage of booking privately is control: you set the departure time, you decide where to stop on the way to Khafji, and you're not sharing the vehicle with strangers. We agree the fare upfront, and our drivers are familiar with this route and its rest stops.</p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Our drivers know the best routes and safe rest points between Tabuk and Khafji.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-start">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-900 p-8 rounded-[2rem] text-white">
                                ...
                                <p className="text-sm text-gray-400">Skip the taxi wait. We go from your house in Tabuk directly to your hotel in Khafji.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                        contextName="Tabuk to Khafji"
                faqs={[
                {
                        question: "Is Khafji directly on the Kuwait border?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, Khafji sits right at the Saudi–Kuwait border on the Gulf coast.",
                        perspectives: []
                    },
                                    {
                        question: "Do you provide 24-hour service for this route given the distance?",
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes, we operate this route around the clock, including night departures from Tabuk if needed.",
                        perspectives: []
                    },
                                    {
                        question: "What vehicles are available for this route?",
                        shortAnswer: "Verified",
                        detailedAnswer: "We offer the Toyota Camry for smaller groups, the Hyundai Staria or GMC Yukon for families, and the Toyota Hiace minibus for larger groups heading to Khafji.",
                        perspectives: []
                    },
                                    {
                        question: "How long does the drive from Tabuk to Khafji take?",
                        shortAnswer: "Verified",
                        ...
                        shortAnswer: "Verified",
                        detailedAnswer: "Yes. The price we quote is for the private vehicle and driver for the full trip to Khafji — you are not sharing the ride with other passengers.",
                        perspectives: []
                    },
                ]}
            />
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Ready to go to Khafji?</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                <RelatedRoutes originSlug="tabuk" currentSlug="tabuk-khafji" />
            </div>
        </div>
    );
}
