...
export const metadata: Metadata = {
    title: 'Taxi Jeddah to Sharjah | VIP Cross-Border Transfer',
    description: 'Book a premium taxi from Jeddah to Sharjah. Reliable cross-border VIP transfers, comfortable SUVs, and door-to-door service across the GCC.',
...
export default function JeddahSharjahRoutePage() {
    const images = ['/locations/sharjah.webp', '/hero-slide-3.webp', '/hero-slide-2.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Jeddah to Sharjah",
        "provider": {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Jeddah to Sharjah."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-jeddah-sharjah"
            ...
            <RouteBreadcrumb fromCity="Jeddah" toCity="Sharjah" fromSlug="jeddah" toSlug="sharjah" />

            <Hero
                images={images}
                h1Text="Taxi Jeddah to Sharjah"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Jeddah%20to%20Sharjah">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                <RelatedLocations currentCity="Sharjah" />
            </div>
