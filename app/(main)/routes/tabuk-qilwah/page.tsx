...
export const metadata: Metadata = {
    title: 'Tabuk to Qilwah Taxi | Private Car Service 1280 km | Fixed Price',
    ...
    openGraph: {
        title: 'Tabuk to Qilwah Taxi | Private Transfer - Fixed Price',
...
export default function TabukQilwahRoutePage() {
    ...
    const routeSchema = {
        ...
        "@type": "TravelAction",
        "name": "Taxi from Tabuk to Qilwah",
        "fromLocation": {
            "@type": "Place",
            "name": "Tabuk",
            "address": {
