...
export const metadata: Metadata = {
    title: 'Riyadh to Bahrain Taxi | Cross-Border Transfer | Taxi Service KSA',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <JsonLdLocation 
                ...
                description="Professional private car service for Riyadh to Bahrain. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
            ...
            <Hero
                ...
                subtitle="Seamless Transfers: Riyadh to Bahrain"
