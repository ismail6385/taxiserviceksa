...
export default function RiyadhBahrainRoutePage() {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Direct drop-off from Riyadh to Bahrain."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="route-schema-riyadh-bahrain"
            ...
            <RouteBreadcrumb fromCity="Riyadh" toCity="Bahrain" fromSlug="riyadh" toSlug="bahrain" />

            <Hero
                images={images}
                h1Text="Taxi Riyadh to Bahrain"
                title={
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Riyadh%20to%20Bahrain">
