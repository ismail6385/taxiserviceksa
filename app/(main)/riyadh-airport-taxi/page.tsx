...
export default function RiyadhAirportTaxiPage() {
    ...
    const relatedSearchFaqs = [
        ...
        },
        {
            ...
            answer: 'Yes. You can reach us via WhatsApp at +966 57 580 6733 or email at info@taxiserviceksa.com. WhatsApp is the fastest way to book and get driver details confirmed. Bookings are accepted 24/7 and can be made before your arrival in Saudi Arabia.',
        },
    ];
