...
export default function RiyadhAirportTaxiPage() {
    ...
    const relatedSearchFaqs = [
        ...
        },
        {
            ...
            answer: 'Yes. You can reach us via WhatsApp at +966 59 020 9905 or email at taxiserviceksa9988@gmail.com. WhatsApp is the fastest way to book and get driver details confirmed. Bookings are accepted 24/7 and can be made before your arrival in Saudi Arabia.',
        },
    ];
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966590209905?text=Hello,%20I%20need%20an%20airport%20transfer%20at%20King%20Khalid%20International%20Airport%20Riyadh" target="_blank">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
                ...
                >
                    <span className="text-sm font-semibold text-emerald-900">
                        Flying in for LEAP Riyadh? See our dedicated airport transportation for LEAP attendees.
                    </span>
