...
export default function RiyadhAirportTaxiPage() {
    ...
    const relatedSearchFaqs = [
        ...
        },
        {
            ...
            answer: 'Yes. You can reach us via WhatsApp at +966 56 948 7569 or email at taxiserviceksa9988@gmail.com. WhatsApp is the fastest way to book and get driver details confirmed. Bookings are accepted 24/7 and can be made before your arrival in Saudi Arabia.',
        },
    ];
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966569487569?text=Hello,%20I%20need%20an%20airport%20transfer%20at%20King%20Khalid%20International%20Airport%20Riyadh" target="_blank">
