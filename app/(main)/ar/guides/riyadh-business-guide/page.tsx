...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://taxiserviceksa.com/ar/guides/riyadh-business-guide/',
        languages: {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Riyadh Business Travel Guide 2024 | Complete Corporate Transport Guide' }],
