...
export const metadata: Metadata = {
    title: 'تاكسي من الدمام إلى جدة | نقل خاص بين المدن | Taxi Service KSA',
    description: 'احجز تاكسي خاص من الدمام إلى جدة. نقل بري طويل المسافة من الباب إلى الباب عبر السعودية بسيارة جمس يوكن أو ستاريا مريحة. أسعار ثابتة وسائقون محترفون.',
    keywords: ['تاكسي الدمام جدة', 'سيارة من الدمام إلى جدة', 'تاكسي الخبر إلى جدة', 'نقل الدمام جدة', 'تاكسي المنطقة الشرقية إلى جدة'],
    alternates: {
        canonical: 'https://taxiserviceksa.com/ar/routes/dammam-jeddah/',
        languages: {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'تاكسي خاص: الدمام إلى جدة | Taxi Service KSA' }],
        siteName: 'Taxi Service KSA',
        title: 'تاكسي خاص: الدمام إلى جدة | Taxi Service KSA',
        description: 'نقل بري بين المدن من الدمام إلى جدة بسيارة خاصة مكيفة. تتوفر خيارات المبيت الليلي والتوقف المتعدد.',
        url: 'https://taxiserviceksa.com/ar/routes/dammam-jeddah/',
        locale: 'ar_SA',
        type: 'website',
    },
};

export default function DammamJeddahRoutePageArabic() {
    const images = [
        '/hero-slide-2.webp',
        '/hero-slide-1.webp',
        '/hero-slide-3.webp',
    ...
    const routeDetails = [
        { label: 'المسافة', value: '١٬٣٠٠ كم', icon: MapPin },
        { label: 'المدة', value: '١٣ - ١٤ ساعة', icon: Clock },
    ...
    return (
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            <JsonLdLocation
                cityName="Dammam to Jeddah"
                description="Private long-distance taxi service from Dammam to Jeddah. Reliable door-to-door transfers with luxury vehicles and professional chauffeurs, coast to coast."
                services={[
                    { name: 'Dammam to Jeddah Taxi', description: 'Premium cross-country private transfer with guaranteed fixed rates.' },
                    { name: 'Executive Chauffeur', description: 'Professional drivers for long-distance business and leisure travel.' },
                    { name: 'Family Van Service', description: 'Spacious vehicles perfect for groups with luggage.' },
                    { name: 'Airport Transfers', description: 'Direct pickups from Dammam / King Fahd International and drop-offs at Jeddah King Abdulaziz International Airport.' }
                ]}
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam&dropoff=Jeddah">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                الدمام إلى جدة: العبور الكامل للمملكة
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                تُعد رحلة الدمام إلى جدة من أطول المسارات الداخلية في المملكة، إذ تعبر شبه الجزيرة من ساحل الخليج العربي إلى ساحل البحر الأحمر. يفضّل معظم المسافرين الطيران لقطع هذه المسافة، لكن بالنسبة للعائلات والمجموعات ذات الأمتعة الكثيرة، أو لمن يفضّل رحلة برية خاصة، تُعد السيارة بسائق خاص بديلاً مريحاً.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                يقطع سائقونا هذا الممر بانتظام، مع محطات راحة مخطط لها على طول الطريق السريع. يمكنك أيضاً تقسيم الرحلة بتوقف ليلي إذا رغبت في ذلك. لا مقاعد مشتركة ولا مواعيد مغادرة ثابتة — فقط سيارة جمس يوكن أو هيونداي ستاريا خاصة حسب جدولك الزمني.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">الاستقبال من أي موقع في الدمام أو الخبر أو الظهران، والتوصيل إلى أي مكان في جدة بما في ذلك المطار أو الكورنيش.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">انطلق في أي وقت يناسبك — تتوفر رحلات المغادرة نهاراً وليلاً.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    <TravelConsensus
                        contextName="الدمام إلى جدة"
                        isRtl={true}
                        points={[
                            {
                                topic: "الطيران مقابل القيادة",
                                commonBelief: "الطيران دائماً أسرع لهذه المسافة.",
                                reality: "الرحلة الجوية المباشرة تستغرق نحو ساعتين، لكن بالنسبة للمجموعات المكوّنة من ٤ أشخاص أو أكثر مع الأمتعة، غالباً ما تتقارب السيارة الخاصة في إجمالي الوقت من الباب إلى الباب بعد احتساب النقل من وإلى المطارين، وهي أكثر راحة بكثير للرحلات العائلية الطويلة.",
                                truthRange: "يعتمد على حجم المجموعة",
                                factors: ["حجم المجموعة", "الأمتعة", "الميزانية"]
                            },
                            {
                                topic: "هل هي رحلة قيادة طويلة؟",
                                commonBelief: "أكثر من ١٣ ساعة يبدو أمراً مرهقاً.",
                                reality: "يقسّم معظم العملاء الرحلة بتوقف للراحة، أو يسافرون ليلاً بحيث ينام الركاب خلال معظم وقت القيادة. الطريق السريع مُعتنى به جيداً وتتوفر فيه محطات خدمة متكررة.",
                                truthRange: "قابلة للتحمل مع فترات الراحة",
            ...
            <div className="bg-black py-24 text-center px-4 relative overflow-hidden rounded-3xl mx-4 mb-12">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link href="/booking/?route=dammam-jeddah">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                />
                <RelatedRoutes originSlug="dammam" currentSlug="dammam-jeddah" title="مسارات أخرى شائعة" />
            </div>
            ...
            <MicroSemanticFAQ
                ...
                faqs={[
                    {
                        question: "كم تستغرق الرحلة من الدمام إلى جدة؟",
                        shortAnswer: "١٣ - ١٤ ساعة",
                        detailedAnswer: "تبلغ المسافة نحو ١٬٣٠٠ كم. في سيارة خاصة مع محطات راحة عادية، يستغرق العبور من ١٣ إلى ١٤ ساعة تقريباً.",
                        perspectives: []
                    },
                    {
                        question: "هل يمكننا التوقف للمبيت في الطريق؟",
                        shortAnswer: "نعم",
                        detailedAnswer: "نعم، يفضّل كثير من العملاء تقسيم الرحلة بتوقف ليلي في فندق. أخبرنا عند الحجز وسنخطط المسار وفق التوقف الذي تفضله.",
                        perspectives: []
                    },
                    {
                        question: "هل تقومون بالاستقبال من الخبر أيضاً؟",
                        shortAnswer: "نعم",
                        detailedAnswer: "نعم، نخدم كامل المنطقة الشرقية بما في ذلك الخبر والدمام والظهران لمسار جدة.",
                        perspectives: []
                    },
                    {
                        question: "هل توصلون إلى مطار جدة؟",
                        shortAnswer: "نعم",
                        detailedAnswer: "نعم، يمكننا توصيلك إلى مطار الملك عبدالعزيز الدولي (JED) في جدة، أو أي فندق أو مكتب أو سكن في المدينة.",
                        perspectives: []
                    }
                ]}
            />
