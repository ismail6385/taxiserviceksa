...
export const metadata: Metadata = {
    ...
    description: 'احجز أفضل تاكسي من الرياض إلى جدة أونلاين. رحلة مباشرة بين المدن تستغرق ٩ إلى ١٠ ساعات من الرياض إلى ساحل البحر الأحمر. أسعار ثابتة، سيارات جمس يوكن، وخدمة من الباب إلى الباب.',
