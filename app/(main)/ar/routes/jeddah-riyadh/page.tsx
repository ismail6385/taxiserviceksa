...
export const metadata: Metadata = {
    ...
    description: 'احجز أفضل تاكسي من جدة إلى الرياض أونلاين. رحلة مباشرة بين المدن تستغرق ٩ إلى ١٠ ساعات عبر السعودية. أسعار ثابتة، سيارات جمس يوكن، وخدمة من الباب إلى الباب.',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'تاكسي جدة إلى الرياض ٢٠٢٦ | سيارة خاصة' }],
