...
export const metadata: Metadata = {
    title: 'تاكسي الدمام إلى الكويت | نقل عبر الحدود | Taxi Service KSA',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'تاكسي الدمام إلى الكويت | Taxi Service KSA' }],
...
export default function DammamKuwaitRoutePageArabic() {
    const images = [
        '/hero-slide-3.webp',
        '/hero-slide-2.webp',
        '/jeddah-airport.webp'
    ...
    return (
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            ...
            <Hero
                images={images}
                h1Text="تاكسي الدمام إلى الكويت"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        خدمة عبور الحدود الخليجية
                    </span>
                }
                subtitle="نقل سلس: من الدمام إلى الكويت"
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <Link href="/booking?pickup=Dammam&dropoff=Kuwait">
                        <Button size="lg" className="bg-white text-black hover:bg-gray-200 font-bold text-lg px-10 py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 group w-full sm:w-auto">
                            حجز عبر واتساب (١٠٠٠ ريال)
                            <ArrowRight className="mr-2 w-5 h-5 rotate-180 group-hover:-translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                    <a href="mailto:taxiserviceksa9988@gmail.com?text=Hello,%20I%20want%20to%20book%20a%20taxi%20from%20Dammam%20to%20Kuwait">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                الطريقة المتميزة للسفر من الدمام إلى الكويت
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                يُعد السفر بين الدمام والكويت عبر الطريق البري خياراً شائعاً للعائلات ورجال الأعمال ومقيمي دول الخليج. تبلغ المسافة نحو ٤٠٠ كم، وتستغرق الرحلة عادة من ٤ إلى ٥ ساعات.
                            </p>
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">نستقبلك من موقعك الدقيق في الدمام ونوصلك مباشرة إلى وجهتك في الكويت.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                <TravelConsensus
                        contextName="الدمام إلى الكويت"
                        isRtl={true}
                        labels={{
                            title: 'تحقّق من حقائق الرحلة: الدمام إلى الكويت',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-16">
                ...
                />
                <RelatedRoutes originSlug="dammam" currentSlug="dammam-kuwait" title="مسارات أخرى شائعة" />
            </div>

            <MicroSemanticFAQ
                isRtl={true}
                labels={{
                    title: 'إجابات الخبراء: الدمام إلى الكويت',
                ...
                faqs={[
                    {
                        question: "كم من الوقت يستغرق التاكسي من الدمام إلى الكويت؟",
                    ...
                    },
                    {
                        ...
                        shortAnswer: "نعم",
                        detailedAnswer: "نعم، يشمل السعر المُعلن ١٠٠٠ ريال تأمين عبور المركبة ورسوم الطرق.",
                        perspectives: []
                    }
                ]}
            />
