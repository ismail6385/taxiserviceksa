...
export const metadata: Metadata = {
    title: 'تاكسي الدمام إلى البحرين | نقل عبر الحدود | Taxi Service KSA',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'تاكسي الدمام إلى البحرين | نقل عبر الحدود | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            <JsonLdLocation
                ...
                description="Professional private car service for Dammam to Bahrain. Reliable 24/7 door-to-door transfers with luxury vehicles and professional chauffeurs."
                services={[
            ...
            <Hero
                ...
                subtitle="نقل سلس: من الدمام إلى البحرين"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="mailto:info@taxiserviceksa.com?text=Hello,%20I%20want%20to%20get%20a%20quote%20for%20a%20taxi%20from%20Dammam%20to%20Bahrain">
