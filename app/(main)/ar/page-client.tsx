                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                ...
                                <a href="https://wa.me/966575806733?text=مرحباً،%20أرغب%20في%20الحصول%20على%20عرض%20سعر%20تاكسي%20VIP" target="_blank" rel="nofollow noopener noreferrer">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                             ...
                             <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
                                <a href="https://wa.me/966575806733?text=مرحباً،%20أرغب%20في%20الحصول%20على%20عرض%20سعر%20تاكسي%20VIP" target="_blank" rel="nofollow noopener noreferrer" className="w-full sm:w-auto">
                                ...
                                <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full border border-gray-200 group-hover:border-primary/50 flex flex-col">
                                    ...
                                    <div className="p-4 sm:p-5 md:p-6 flex-1 flex flex-col">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 mt-auto">
                                            ...
                                            <a
                                                href={`https://wa.me/966575806733?text=مرحباً،%20أرغب%20في%20الحصول%20على%20عرض%20سعر%20VIP%20لسيارة%20${encodeURIComponent(vehicle.name)}.`}
                                                target="_blank"
