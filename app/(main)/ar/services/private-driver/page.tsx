...
export default function PrivateDriverPageArabic() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'يتم الحجز عبر واتساب (966563573531+) أو البريد الإلكتروني (taxiserviceksa9988@gmail.com). زودونا بالتواريخ وعدد الركاب ونوع السيارة المفضل والوجهات المخطط لها. للاستئجار ليوم كامل أو عدة أيام، يُنصح بالحجز قبل ٢٤–٤٨ ساعة. لا حاجة لرقم هاتف سعودي أو حساب محلي — نقبل الحجوزات الدولية.',
        },
    ];
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966563573531?text=مرحباً،%20أريد%20استئجار%20سائق%20خاص%20في%20السعودية" target="_blank">
