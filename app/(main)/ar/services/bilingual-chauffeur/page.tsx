...
export default function BilingualChauffeurPageArabic() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'يتم الحجز عبر واتساب (966590209905+) أو البريد الإلكتروني (taxiserviceksa9988@gmail.com) بالكامل بالإنجليزية. لا حاجة لشريحة سعودية أو رقم محلي. زوّدونا بتاريخ وصولكم، ورقم رحلة الطيران إن وجد، ومكان الاستلام والوجهة. نؤكد الحجز عبر واتساب ونرسل بيانات السائق قبل رحلتكم.',
        },
        {
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966590209905?text=مرحباً،%20أحتاج%20سائقاً%20يتحدث%20الإنجليزية%20في%20السعودية" target="_blank">
