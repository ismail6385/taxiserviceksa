        ...
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966563573531?text=مرحباً،%20أحتاج%20توصيل%20فندقي%20في%20الرياض" target="_blank">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-center mt-8 text-sm text-gray-500">لم تجد فندقك؟ نغطي <strong>جميع الفنادق</strong> في الرياض. <Link href="https://wa.me/966563573531?text=مرحباً،%20أحتاج%20توصيل%20فندقي%20في%20الرياض" className="text-black font-bold hover:underline">تواصل معنا ←</Link></p>
                </div>
            </section>
