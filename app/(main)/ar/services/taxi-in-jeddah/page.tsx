    ...
    return (
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            ...
            <Hero
                ...
                subtitle="توصيل من المطار، سفر الشركات، وسائقون من الطراز الأول."
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-primary/5 p-8 rounded-3xl border border-primary/10">
                        <div>
                            ...
                            <p className="text-gray-600">اختر وجهتك من جدة للحصول على نقل.</p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-4xl">
                            <p>هل وصلت إلى **مطار الملك عبدالعزيز الدولي (KAIA)** وتحتاج إلى نقل فوري؟ أم أنك مدير تنفيذي يحتاج سائقاً موثوقاً ليوم كامل من الاجتماعات على كورنيش جدة؟ العثور على **تاكسي فاخر في جدة** لم يعد أمراً مرهقاً بفضل خدمة السائق الخاص التي يمكن حجزها مسبقاً.</p>
                            <p>نقدم بديلاً راقياً بالكامل عن تطبيقات مشاركة الركوب وسيارات الأجرة الخضراء التقليدية في الشارع. يضم أسطولنا أحدث موديلات مرسيدس وبي إم دبليو وكاديلاك. نتخصص في استقبال سلس من المطار (حيث ينتظرك سائقنا بلوحة اسم)، ورحلات بين المدن إلى مكة لأداء العمرة، وتأجير سيارات التنفيذية مع سائق خاص.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:border-black/5 transition-colors">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3">تنظيم رحلات المجموعات</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {fleet.map((v, i) => (
                            <div key={i} className="bg-white/5 border border-white/10 rounded-3xl p-6 hover:bg-white/10 transition-all group">
                                ...
                                <a
                                    href={`https://wa.me/966590209905?text=مرحباً،%20أرغب%20في%20حجز%20سيارة%20VIP%20${encodeURIComponent(v.name)}%20في%20جدة.`}
                                    target="_blank"
                    ...
                    <div>
                        <div className="bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 relative overflow-hidden">
                            ...
                            <p className="text-gray-700 leading-relaxed text-sm relative z-10">
                                معنا، تحصل على **سيارة مؤكدة**. يستقبلك سائقنا داخل صالة المطار. تحصل بالضبط على السيارة الفاخرة التي طلبتها (مثل إس كلاس أو إسكاليد)، وسعرك لا يتغير أبداً، مما يخلق تجربة سفر سلسة تماماً.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <MicroSemanticFAQ
                ...
                faqs={[
                    {
                        question: "هل يمكنني طلب عرض سعر لتاكسي من مطار جدة؟",
