...
export const metadata: Metadata = {
    ...
    description: 'خدمة شوفير خاصة من السعودية إلى دول الخليج — دبي وأبوظبي والكويت وقطر والبحرين. نقل عبر الحدود من الباب إلى الباب بأسعار ثابتة.',
        ...
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    ...
                    <a href="https://wa.me/966590209905?text=مرحباً،%20أحتاج%20عرض%20سعر%20لخدمة%20شوفير%20عبر%20حدود%20دول%20الخليج" target="_blank" rel="noopener noreferrer">
