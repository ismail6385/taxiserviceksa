    ...
    return (
        <div className="bg-gray-50 min-h-screen rtl" dir="rtl">
            ...
            <Hero
                ...
                subtitle="احجز مسبقاً سيارات خاصة موثوقة ودفع رباعي لرحلات الحج والعمرة والتنقل بين المدن."
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        ...
                        <div className="prose prose-lg text-gray-600 max-w-4xl">
                            <p>قد يكون إيجاد <strong>تاكسي موثوق في مكة</strong> خلال مواسم الحج والعمرة المزدحمة أمراً صعباً للغاية. سواء كنت بحاجة إلى استقبال سريع من فندقك القريب من الحرم (مثل جبل عمر)، أو رحلة مريحة طويلة إلى المدينة المنورة، نوفر خدمة سائق خاص بالحجز المسبق تُغنيك عن عناء استيقاف السيارات في الشارع.</p>
            ...
            <section className="py-24 bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black mb-6">أسطول مكة</h2>
                ...
                faqs={[
                    {
                        ...
                        detailedAnswer: "يمكنك حجز خدمة تاكسي مكة مباشرة عبر نموذج الحجز في موقعنا أو بإرسال بريد إلكتروني لنا. أخبرنا بموقع الاستقبال في مكة، ووجهتك، والتاريخ، وحجم مجموعتك. سنؤكد لك سيارة فوراً.",
                        perspectives: []
                    },
                    {
