...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://taxiserviceksa.com/ar/services/cable-car/',
        languages: {
                            ...
                            <div key={i} className="bg-gray-50 rounded-2xl overflow-hidden hover:shadow-xl transition-all group border border-gray-200">
                                ...
                                <div className="p-6">
                                    ...
                                    <Link href="/booking/" className="block mt-6">
                                        <Button variant="outline" className="w-full border-emerald-600 text-emerald-700 hover:bg-emerald-50">WhatsApp Booking Here</Button>
                                    </Link>
                                </div>
                            </div>
                        ))}
