...
function CompletedContent() {
    ...
    const reviewWA = encodeURIComponent(
        `Hi Taxi Service KSA, I just completed my trip ${refId}. I would like to share my feedback.`
    );
        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
            <div className="max-w-lg w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500">Thank you for choosing Taxi Service KSA.</p>
                    {refId && (
                ...
                <div className="space-y-3">
                    <a
                        href={`https://wa.me/966590209905?text=${reviewWA}`}
                        target="_blank"
