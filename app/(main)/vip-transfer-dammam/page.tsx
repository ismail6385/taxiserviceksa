...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Book via WhatsApp at +966 56 948 7569 or through our website. Specify: pickup location in Al Khobar (street address or landmark), destination, date and time, and number of passengers. We confirm within minutes. For corporate accounts, call or WhatsApp for monthly package rates.',
    },
];
            ...
            <section className="bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="https://wa.me/966569487569?text=Hi,%20I%20need%20a%20VIP%20transfer%20in%20Dammam" target="_blank" rel="noopener noreferrer"
