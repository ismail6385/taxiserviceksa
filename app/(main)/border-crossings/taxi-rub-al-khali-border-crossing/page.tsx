...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service at Rub al Khali Border Crossing | Taxi Service KSA' }],
...
export default function RubalKhaliBorderPage() {
    const images = ['/hero-slide-3.webp', '/hero-slide-2.webp', '/jeddah-airport.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Rub al Khali Border Crossing (Oman)",
        "provider": {
            "@type": "TransportationService",
            "name": "TaxiServiceKSA"
        },
        "areaServed": [
            { "@type": "Place", "name": "Rub al Khali Border" },
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Premium transport to and from the Rub al Khali border."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="border-schema-taxi-rub-al-khali-border-crossing"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="mailto:taxiserviceksa9988@gmail.com?subject=Immediate%20Taxi%20Request%20-%20Rub%20al%20Khali%20Border">
                    ...
                    <Link href="/booking?pickup=Rub al Khali%20Border&dropoff=Riyadh">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Book With Us at Rub al Khali?</h3>
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Our experienced staff can help guide you on the necessary paperwork to make the Rub al Khali customs process smoother.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                        ...
                        points={[
                            {
                                ...
                                commonBelief: "It's easy to find a regular taxi once I cross the Rub al Khali border.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "Can I get a taxi exactly at the Rub al Khali immigration checkpoint?",
                        shortAnswer: "Yes, pre-book with us and we will meet you just outside the checkpoint.",
                        detailedAnswer: "Yes! If you are walking through the Rub al Khali border, our driver will park at the designated waiting area just after you clear customs and passport control on either the Saudi or Oman side.",
                        perspectives: []
                    },
                    {
                        question: "How long does it take from Rub al Khali border to Riyadh?",
