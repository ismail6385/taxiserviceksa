...
export const metadata: Metadata = {
    title: 'Taxi Al Haditha Border Crossing (Jordan) | 24/7 VIP Transfers',
    description: 'Need a taxi at Al Haditha Border? We provide reliable, 24/7 VIP cross-border transfers between Saudi Arabia and Jordan. Get a quote now.',
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                ...
                subtitle="Stranded at Al Haditha? We provide immediate VIP transfers."
                location="24/7 Border Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="https://wa.me/966569487569?text=Hello,%20I%20need%20a%20taxi%20at%20the%20Al Haditha%20Border%20Crossing.">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                VIP Taxi Services at Al Haditha
                            </h2>
