...
export const metadata: Metadata = {
    title: 'Private Car, Taxi and Chauffeur Service at Ramlat Khaliya Border Crossing | Taxi Service KSA',
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service at Ramlat Khaliya Border Crossing | Taxi Service KSA' }],
...
export default function RamlatKhaliyaBorderPage() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                images={images}
                h1Text="Private Car, Taxi and Chauffeur Service at Ramlat Khaliya Border Crossing"
                title={
                    <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold tracking-wider uppercase px-4 py-2 rounded-lg inline-block decoration-clone leading-snug">
                        Saudi & Oman Border Service
                    </span>
                }
                subtitle="Stranded at Ramlat Khaliya? We provide immediate transfers."
                location="24/7 Border Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="mailto:taxiserviceksa9988@gmail.com?subject=Immediate%20Taxi%20Request%20-%20Ramlat%20Khaliya%20Border">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6"> Taxi Services at Ramlat Khaliya
                            </h2>
