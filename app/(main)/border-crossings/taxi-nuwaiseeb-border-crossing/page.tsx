...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service at Nuwaiseeb Border Crossing | Taxi Service KSA' }],
...
export default function NuwaiseebBorderPage() {
    const images = ['/hero-slide-3.webp', '/hero-slide-2.webp', '/jeddah-airport.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Nuwaiseeb Border Crossing (Kuwait)",
        "provider": {
            "@type": "TransportationService",
            "name": "TaxiServiceKSA"
        },
        "areaServed": [
            { "@type": "Place", "name": "Nuwaiseeb Border" },
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Premium transport to and from the Nuwaiseeb border."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="border-schema-taxi-nuwaiseeb-border-crossing"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="https://wa.me/966590209905?text=Hello%2C%20I%20want%20to%20book%20a%20taxi%20from%20Nuwaiseeb%20Border%20Crossing" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                    ...
                    <Link href="/booking?pickup=Nuwaiseeb%20Border&dropoff=Riyadh" className="w-full sm:w-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                We specialize in high-comfort, long-distance SUV and Sedan transfers to major cities like Riyadh (530 km away), Dammam, and Jeddah. Our drivers are fully licensed and hold valid clearance for GCC borders.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Book With Us at Nuwaiseeb?</h3>
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Our experienced staff can help guide you on the necessary paperwork to make the Nuwaiseeb customs process smoother.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                        ...
                        points={[
                            {
                                ...
                                commonBelief: "It's easy to find a regular taxi once I cross the Nuwaiseeb border.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "Can I get a taxi exactly at the Nuwaiseeb immigration checkpoint?",
                        shortAnswer: "Yes, pre-book with us and we will meet you just outside the checkpoint.",
                        detailedAnswer: "Yes! If you are walking through the Nuwaiseeb border, our driver will park at the designated waiting area just after you clear customs and passport control on either the Saudi or Kuwait side.",
                        perspectives: []
                    },
                    {
                        question: "How long does it take from Nuwaiseeb border to Riyadh?",
                        shortAnswer: "Approx 530 km",
                        detailedAnswer: "The distance to Riyadh is roughly 530 km. Travel times vary but we ensure a comfortable ride in our late-model SUVs with adequate rest stops along the way.",
                        perspectives: []
                    },
                    {
