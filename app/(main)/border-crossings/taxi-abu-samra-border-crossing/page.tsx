...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service at Abu Samra Border Crossing | Taxi Service KSA' }],
...
export default function AbuSamraBorderPage() {
    const images = ['/locations/doha.webp', '/hero-slide-3.webp', '/hero-slide-2.webp'];

    const routeSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Taxi Abu Samra Border Crossing (Qatar)",
        "provider": {
            "@type": "TransportationService",
            "name": "TaxiServiceKSA"
        },
        "areaServed": [
            { "@type": "Place", "name": "Abu Samra Border" },
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Premium transport to and from the Abu Samra border."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <Script
                id="border-schema-taxi-abu-samra-border-crossing"
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="mailto:taxiserviceksa9988@gmail.com?subject=Immediate%20Taxi%20Request%20-%20Abu%20Samra%20Border">
                    ...
                    <Link href="/booking?pickup=Abu Samra%20Border&dropoff=Riyadh">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                We specialize in high-comfort, long-distance SUV and Sedan transfers to major cities like Riyadh (460 km away), Dammam, and Jeddah. Our drivers are fully licensed and hold valid clearance for GCC borders.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Book With Us at Abu Samra?</h3>
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Our experienced staff can help guide you on the necessary paperwork to make the Abu Samra customs process smoother.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                        ...
                        points={[
                            {
                                ...
                                commonBelief: "It's easy to find a regular taxi once I cross the Abu Samra border.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "Can I get a taxi exactly at the Abu Samra immigration checkpoint?",
                        shortAnswer: "Yes, pre-book with us and we will meet you just outside the checkpoint.",
                        detailedAnswer: "Yes! If you are walking through the Abu Samra border, our driver will park at the designated waiting area just after you clear customs and passport control on either the Saudi or Qatar side.",
                        perspectives: []
                    },
                    {
                        question: "How long does it take from Abu Samra border to Riyadh?",
                        shortAnswer: "Approx 460 km",
                        detailedAnswer: "The distance to Riyadh is roughly 460 km. Travel times vary but we ensure a comfortable ride in our late-model SUVs with adequate rest stops along the way.",
                        perspectives: []
                    },
                    {
