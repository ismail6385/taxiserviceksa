...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Private Car, Taxi and Chauffeur Service at Khafji Border Crossing | Taxi Service KSA' }],
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                ...
                subtitle="Stranded at Khafji? We provide immediate transfers."
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6"> Taxi Services at Khafji
                            </h2>
