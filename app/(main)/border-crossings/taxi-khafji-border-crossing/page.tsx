...
export const metadata: Metadata = {
    ...
    description: 'Need a taxi at Khafji Border? We provide reliable, 24/7 VIP cross-border transfers between Saudi Arabia and Kuwait. Get a quote now.',
...
export default function KhafjiBorderPage() {
    ...
    const routeSchema = {
        ...
        "@type": "Service",
        "name": "Taxi Khafji Border Crossing (Kuwait)",
        "provider": {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Premium transport to and from the Khafji border."
                    }
                }
            ]
        }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <Hero
                ...
                subtitle="Stranded at Khafji? We provide immediate VIP transfers."
                location="24/7 Border Pickups"
            >
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <a href="https://wa.me/923080628195?text=Hello,%20I%20need%20a%20taxi%20at%20the%20Khafji%20Border%20Crossing.">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                                VIP Taxi Services at Khafji
                            </h2>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Arriving at the Khafji border crossing between Saudi Arabia and Kuwait can be stressful, especially if you lack onward transportation. Whether your previous driver couldn't cross, or you're walking through passport control, our premium taxis are ready to pick you up directly from either side of the border.
                            </p>
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                We specialize in high-comfort, long-distance SUV and Sedan transfers to major cities like Riyadh (520 km away), Dammam, and Jeddah. Our drivers are fully licensed and hold valid clearance for GCC borders.
                            </p>
                        ...
                        <div className="bg-gray-100 rounded-3xl p-8 border border-gray-200">
                            <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Book With Us at Khafji?</h3>
                            <ul className="space-y-6">
                                ...
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Our experienced staff can help guide you on the necessary paperwork to make the Khafji customs process smoother.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                        ...
                        points={[
                            {
                                ...
                                commonBelief: "It's easy to find a regular taxi once I cross the Khafji border.",
            ...
            <MicroSemanticFAQ
                faqs={[
                    {
                        question: "Can I get a taxi exactly at the Khafji immigration checkpoint?",
                        shortAnswer: "Yes, pre-book with us and we will meet you just outside the checkpoint.",
                        detailedAnswer: "Yes! If you are walking through the Khafji border, our driver will park at the designated waiting area just after you clear customs and passport control on either the Saudi or Kuwait side.",
                        perspectives: []
                    },
                    {
                        question: "How long does it take from Khafji border to Riyadh?",
                        shortAnswer: "Approx 520 km",
                        detailedAnswer: "The distance to Riyadh is roughly 520 km. Travel times vary but we ensure a comfortable ride in our late-model SUVs with adequate rest stops along the way.",
                        perspectives: []
                    },
                    {
