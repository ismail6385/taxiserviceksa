            ...
            <main className="max-w-3xl mx-auto px-4 py-10">
                ...
                <div className="tldr-summary bg-muted border-l-4 border-primary rounded-r-lg p-5 mb-8">
                    ...
                    <ul className="space-y-1 text-sm">
                        ...
                        <li>✅ <strong>How to book:</strong> WhatsApp +966 56 357 3531 — 24 hours advance booking recommended</li>
                    </ul>
                </div>
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-5 mb-8">
                    ...
                    <a
                        href="https://wa.me/966563573531?text=Hi%2C%20I%20need%20a%20private%20car%20from%20Dammam%20to%20Bahrain.%20Please%20share%20availability%20and%20pricing."
                        target="_blank"
