            ...
            <section className="relative bg-gradient-to-br from-cyan-950 via-blue-950 to-slate-950 text-white py-20 px-4 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4">
                        <a href="https://wa.me/966590209905?text=Hi,%20I%20need%20a%20transfer%20to%20a%20Jeddah%20beach" target="_blank" rel="noopener noreferrer"
            ...
            <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
                    ...
                    <article key={beach.rank} className={`rounded-3xl border ${beach.border} bg-gradient-to-br ${beach.gradient} overflow-hidden shadow-sm`}>
                        ...
                        <div className="px-8 pb-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a href={`https://wa.me/966590209905?text=Hi,%20I%20need%20a%20transfer%20to%20${encodeURIComponent(beach.name.split('—')[0].trim())}`}
                ...
                <section className="bg-gradient-to-br from-cyan-900 to-blue-950 text-white rounded-3xl p-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/966590209905?text=Hi,%20I%20need%20a%20transfer%20to%20Obhur%20Creek%20beach%20in%20Jeddah" target="_blank" rel="noopener noreferrer"
