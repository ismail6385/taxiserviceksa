            ...
            <section className="bg-gradient-to-br from-slate-950 via-emerald-950 to-black text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4">
                        <a href="https://wa.me/966575806733?text=Hi,%20I%20need%20a%20driver%20to%20explore%20Jeddah%20attractions" target="_blank" rel="noopener noreferrer"
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 space-y-10">
                    ...
                    <article key={place.rank} className={`rounded-3xl border ${place.borderColor} bg-gradient-to-br ${place.gradient} overflow-hidden shadow-sm`}>
                        ...
                        <div className="px-8 pb-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <a href="https://wa.me/966575806733?text=Hi,%20I%20need%20a%20private%20driver%20for%20Jeddah%20sightseeing" target="_blank" rel="noopener noreferrer"
                ...
                <section className="bg-gradient-to-br from-emerald-900 to-slate-900 text-white rounded-3xl p-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/966575806733?text=Hi,%20I%20want%20to%20book%20a%20full%20day%20sightseeing%20driver%20in%20Jeddah" target="_blank" rel="noopener noreferrer"
