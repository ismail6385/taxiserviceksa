            ...
            <article className="max-w-4xl mx-auto px-4 py-16 space-y-20">
                            ...
                            <div key={i} className={`rounded-2xl p-6 border ${opt.highlight ? 'bg-emerald-50 border-emerald-200' : 'bg-gray-50 border-gray-100'}`}>
                                ...
                                {opt.cta && (
                                    <div className="mt-4 flex flex-wrap gap-3">
                                        <a href="https://wa.me/966590209905?text=Hi,%20I%20need%20a%20taxi%20in%20Jeddah" target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                        {[
                            ...
                            },
                            {
                                ...
                                content: 'Police: 911 | Ambulance: 911 | Fire: 911 (unified emergency number) | Tourist Police: 920000897. Our driver WhatsApp (+966 59 020 9905) is also available 24/7 for any transport assistance during your stay.',
                            },
                        ].map((tip, i) => (
                ...
                <section className="bg-gradient-to-br from-emerald-900 to-slate-900 text-white rounded-3xl p-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/966590209905?text=Hi,%20I%20am%20visiting%20Jeddah%20and%20need%20a%20taxi%20transfer" target="_blank" rel="noopener noreferrer"
