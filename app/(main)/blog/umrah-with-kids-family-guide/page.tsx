            ...
            <section className="bg-gradient-to-br from-emerald-950 via-slate-900 to-teal-950 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4">
                        <a href="https://wa.me/966575806733?text=Hi,%20I%20am%20planning%20Umrah%20with%20my%20children%20and%20need%20a%20family-friendly%20taxi%20with%20child%20seats" target="_blank" rel="noopener noreferrer"
            ...
            <article className="max-w-4xl mx-auto px-4 py-16 space-y-16">
                ...
                <section className="bg-gradient-to-br from-emerald-950 to-slate-900 text-white rounded-3xl p-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/966575806733?text=Hi,%20I%20am%20planning%20Umrah%20with%20my%20family%20and%20need%20a%20taxi%20with%20child%20seats" target="_blank" rel="noopener noreferrer"
