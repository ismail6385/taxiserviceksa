            ...
            <div className="max-w-4xl mx-auto px-4 py-16">
                ...
                <section className="mb-16 bg-black text-white rounded-3xl p-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://wa.me/966575806733?text=Hello,%20I%20need%20a%20price%20for%20private%20car%20from%20Tabuk%20to%20NEOM" target="_blank" rel="noopener noreferrer">
