            ...
            <main className="max-w-3xl mx-auto px-4 py-10">
                ...
                <div className="tldr-summary bg-muted border-l-4 border-primary rounded-r-lg p-5 mb-8">
                    ...
                    <ul className="space-y-1 text-sm">
                        ...
                        <li>✅ <strong>Book in advance:</strong> WhatsApp +966 57 580 6733</li>
                    </ul>
                </div>
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-5 mb-8">
                    ...
                    <a
                        href="https://wa.me/966575806733?text=Hi%2C%20I%20need%20a%20private%20car%20from%20Madinah%20to%20AlUla.%20Please%20share%20availability%20and%20pricing."
                        target="_blank"
