...
const faqJsonLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Book via WhatsApp at +966 57 580 6733. Send your flight number, arrival date, number of passengers, and destination. We confirm within 30 minutes and send driver details — name, photo, vehicle plate — before your flight lands. The driver meets you at DMM arrivals with a name sign.',
            },
        },
    ],
};
        ...
        <>
            ...
            <main className="max-w-3xl mx-auto px-4 py-10">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-5 mb-8">
                    ...
                    <a
                        href="https://wa.me/966575806733?text=Hi%2C%20I%20need%20a%20transfer%20from%20Dammam%20Airport%20(DMM).%20Please%20share%20availability%20and%20pricing."
                        target="_blank"
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            },
                            {
                                ...
                                a: 'Book via WhatsApp at +966 57 580 6733. Send your flight number, arrival date, number of passengers, and destination. We confirm within 30 minutes and send driver details before your flight lands. The driver meets you at DMM arrivals with a name sign.',
                            },
                        ].map((item, i) => (
