            ...
            <section className="bg-gradient-to-br from-emerald-950 via-slate-900 to-emerald-900 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4">
                        <a href="https://wa.me/966563573531?text=Hi,%20I%20am%20in%20Ihram%20and%20need%20a%20private%20taxi%20from%20Jeddah%20to%20Makkah" target="_blank" rel="noopener noreferrer"
            ...
            <article className="max-w-4xl mx-auto px-4 py-16 space-y-12">
                ...
                <section className="bg-gradient-to-br from-emerald-950 to-slate-900 text-white rounded-3xl p-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://wa.me/966563573531?text=Hi,%20I%20will%20be%20in%20Ihram%20and%20need%20a%20taxi%20from%20Jeddah%20Airport%20to%20Makkah" target="_blank" rel="noopener noreferrer"
