...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Yes, same-day bookings are available subject to driver availability. WhatsApp us at +966 59 020 9905 with your hotel name and required departure time. During Hajj and Umrah peak seasons, we recommend booking at least 24 hours in advance to guarantee your vehicle.',
    },
];
            ...
            <section className="bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-900 text-white py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="https://wa.me/966590209905?text=Hi,%20I%20need%20a%20taxi%20from%20Makkah%20to%20Jeddah" target="_blank" rel="noopener noreferrer"
