...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Makkah Umrah Complete Guide 2026 | Everything Pilgrims Need' }],
        ...
        url: 'https://taxiserviceksa.com/ur/guides/makkah-umrah-guide/',
        type: 'article',
    },
};
