...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://taxiserviceksa.com/ur/guides/jeddah-airport-guide/',
        languages: {
    ...
    openGraph: {
        images: [{ url: 'https://taxiserviceksa.com/og-image.jpg', width: 1200, height: 630, alt: 'Jeddah Airport Complete Guide 2026 | King Abdulaziz Airport' }],
        ...
        url: 'https://taxiserviceksa.com/ur/guides/jeddah-airport-guide/',
        type: 'article',
    },
};
