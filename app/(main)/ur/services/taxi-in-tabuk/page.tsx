...
export default function TaxiInTabukPageUrdu() {
    const fleet = [
        ...
        { name: 'Ford Taurus 2026', type: 'ایگزیکٹو سیڈان', pax: '3', lugg: '2', img: 'Car' },
             ...
             <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white font-urdu text-right">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center md:text-right">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 leading-tight mb-8"> تبوک کی وی آئی پی ٹیکسی سروس
                        </h2>
                        <div className="prose prose-lg text-slate-600 max-w-4xl mx-auto md:mr-0 ml-auto leading-relaxed">
                            ...
                            <p>ہم تبوک میں کسی بھی مقام یا ایئرپورٹ سے براہ راست **نیوم، دی لائن (The Line)، العلا**، اور یہاں تک کہ کراس کنٹری (جدہ یا مکہ) کو پرائیویٹ کارز فراہم کرتے ہیں۔ چونکہ شمالی شہروں کے درمیان فاصلے وسیع ہیں، ہم آپ کے سکون کے لیے صرف احتیاط سے برقرار رکھی گئی لگژری سیڈان، SUVs جیسے Escalade اور کشادہ مرسڈیز وینز تعینات کرتے ہیں۔ آپ کا آرام اور تحفظ ہماری اولین ترجیح ہے۔</p>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <div className="bg-slate-50 rounded-[2.5rem] p-10 lg:p-14 border border-slate-200 relative overflow-hidden shadow-xl">
                            ...
                            <p className="text-slate-800 leading-relaxed text-base relative z-10 font-medium bg-white/60 p-5 rounded-xl border border-blue-100"> ہمارے چوفیرز (ڈرائیورز) مقامی پیشہ ور افراد ہیں جو ہائی وے یا صحرائی گاڑی چلانے کا وسیع اور انتہائی محفوظ تجربہ رکھتے ہیں۔ ہم اس بات کو یقینی بناتے ہیں کہ طویل سفر سے پہلے ہر ٹیکسی، جیسے ہماری GMC یا S-Class، کا بخوبی معائنہ کیا جائے، تاکہ صحرائی آب و ہوا میں بھی آپ کی سلامتی اور مکمل سکون کی ضمانت دی جا سکے۔
                            </p>
                        </div>
                    </div>
                </div>
