                        ...
                        faqs={[
                            {
                                ...
                                detailedAnswer: "براہ کرم اپنی کمپنی کی تفصیلات کے ساتھ ہماری کارپوریٹ سیلز ٹیم کو taxiserviceksa9988@gmail.com پر ای میل کریں۔ ہم آپ کی ضروریات کا جائزہ لے کر ایک مختص بکنگ پورٹل اور کریڈٹ ٹرمز (Credit Terms) کے ساتھ آپ کا اکاؤنٹ ترتیب دیں گے۔",
                                perspectives: [
                                    {
