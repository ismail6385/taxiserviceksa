...
export default function CorporateTravelPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Yes. Riyadh to Jeddah business corridor (950km, 9-10 hours) is available with executive vehicles (GMC Yukon). Service includes rest stops, refreshments, and flexible departure times. Overnight stays can be arranged for driver. We offer competitive corporate rates."
        },
        {
