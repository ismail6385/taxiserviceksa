...
export default function ServicesPageUrdu() {
    const services = [
        ...
        },
        {
            ...
            description: 'سعودی عرب کے تمام بڑے ایئرپورٹس پر پریمیم Meet-and-Greet سروس۔ ہمارے چوفیرز (ڈرائیورز) ٹرمینل یا گیٹ پر آپ کے نام والے بورڈ کے ساتھ استقبال کے لیے انتظار کرتے ہیں۔',
            icon: Plane,
        ...
        },
        {
            ...
            features: ['KAFD اور اہم بزنس مراکز', 'میٹنگز میں پابندیِ وقت', 'چنیدہ پریمیم گاڑیاں', 'فی گھنٹہ کرایہ/بکنگ کی سہولت'],
            isPopular: false
        },
        {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-right">
                ...
                <div className="text-center md:text-right mb-16">
                    ...
                    <p className="text-xl text-slate-600 max-w-3xl md:mx-0 mx-auto leading-relaxed">
                        **VIP Transfer KSA** مقامی پبلک ٹرانسپورٹ کا ایک پریمیم متبادل (Alternative) فراہم کرتا ہے۔ ہم خاص طور پر بین الاقوامی مہمانوں اور کمپنیوں کے لیے **پری بُکڈ (Pre-booked) پرائیویٹ سفر**، لمبے راستوں پر سفر اور گھنٹوں کے حساب سے گاڑیوں کے کرائے پر مہارت رکھتے ہیں۔
                    </p>
                </div>
