...
export default function Breadcrumbs() {
    ...
    const segmentLabels: Record<string, string> = {
        ...
        'bus': 'Bus',
        'riyadh-to-bahrain': 'Riyadh to Bahrain Bus',
        'al-khobar-to-bahrain': 'Al Khobar to Bahrain Bus',
        'dammam-to-bahrain': 'Dammam to Bahrain Bus',
        'al-ahsa-to-bahrain': 'Al Ahsa to Bahrain Bus',
        'jubail-to-bahrain': 'Jubail to Bahrain Bus',
        'riyadh-to-dubai': 'Riyadh to Dubai Bus',
        'blog': 'Blog',
        'about': 'About Us',
        'contact': 'Contact',
        'jeddah': 'Jeddah',
