                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3.5">
                            ...
                            <li><Link href="/calculator/" className="text-sm text-gray-300 hover:text-white transition-colors">Fare Calculator</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3.5">
                            ...
                            <li>
                                <a href="tel:+966575806733" className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
                                    <Phone className="w-4 h-4 shrink-0" />
                                    +966 57 580 6733
                                </a>
                            </li>
                            <li>
                                <a href="mailto:info@taxiserviceksa.com" className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
                    ...
                    <div>
                        ...
                        <a
                            href="https://wa.me/966575806733?text=Hello%2C%20I%20want%20to%20get%20a%20taxi%20quote."
                            target="_blank"
                            rel="nofollow noopener noreferrer"
