                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3.5">
                            <li>
                                <a
                                    href="https://wa.me/966563573531?text=Hello%2C%20I%20would%20like%20to%20get%20a%20transfer%20quote."
                                    target="_blank"
                            ...
                            <li>
                                <a href="tel:+966563573531" className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
                    ...
                    <div>
                        ...
                        <a
                            href="https://wa.me/966563573531?text=Hello%2C%20I%20want%20to%20get%20a%20taxi%20quote."
                            target="_blank"
                            rel="nofollow noopener noreferrer"
