            ...
            {step === 3 && selectedVehicle && (
                <form onSubmit={handleSubmitBooking} className="animate-fade-in-up space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <a href="https://wa.me/966563573531?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20a%20transfer." target="_blank" rel="nofollow noopener noreferrer" className="block w-full">
                            <Button
                                type="button"
