                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-center hover:border-emerald-500 transition-colors cursor-pointer group">
                                ...
                                <Link href={`https://wa.me/966575806733?text=${encodeURIComponent(`Hello, I want to book a Sedan from ${CITY_LABELS[from]} to ${CITY_LABELS[to]}${result.sedan ? ` (quoted SAR ${result.sedan})` : ''}.`)}`}>
                            ...
                            <div className="bg-emerald-50 p-4 rounded-xl border-2 border-emerald-500 text-center relative overflow-hidden">
                                ...
                                <Link href={`https://wa.me/966575806733?text=${encodeURIComponent(`Hello, I want to book an SUV from ${CITY_LABELS[from]} to ${CITY_LABELS[to]}${result.suv ? ` (quoted SAR ${result.suv})` : ''}.`)}`}>
                                    <Button size="sm" className="w-full bg-emerald-600 hover:bg-emerald-700">WhatsApp Quote</Button>
                                </Link>
                            </div>
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-center hover:border-emerald-500 transition-colors cursor-pointer group">
                                ...
                                <Link href={`https://wa.me/966575806733?text=${encodeURIComponent(`Hello, I want to book Group Transport from ${CITY_LABELS[from]} to ${CITY_LABELS[to]}${result.van ? ` (quoted SAR ${result.van})` : ''}.`)}`}>
                                    <Button size="sm" className="w-full bg-emerald-600 hover:bg-emerald-700">WhatsApp Quote</Button>
                                </Link>
                            </div>
                        </div>
