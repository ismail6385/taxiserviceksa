    ...
    const securityHeaders = [
      ...
      // Content Security Policy — upgrade HTTP to HTTPS + restrict sources
      {
        ...
        value: [
          ...
          "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://vitals.vercel-insights.com https://*.clarity.ms https://*.bing.com https://*.google-analytics.com https://*.g.doubleclick.net https://stats.g.doubleclick.net",
